...
\newcommand{\sbmlthreecore}                 {SBML Level~3 \changed{Version~2} Core\xspace}
\newcommand{\comppkg}                       {SBML Level~3 Package Specification for Hierarchical Model Composition, \changed{Version~2}}

...
(References: SBML Level~3 Package Specification for Flux Balance
Constraints, Version~2, \sec{fluxbound-class}.) }
...
\GeneAssociation within a \Reaction object using Flux Balance
...
\subsubsection*{Rules for \class{GeneAssociation} object}

\validRule{fbc-20801}{A \GeneAssociation object may have the optional SBML
Level 3 Core attributes \token{metaid} and \token{sboTerm}. No other
attributes from the SBML Level 3 Core namespace are permitted on a
\GeneAssociation. (References: SBML Level~3 Version~1 Core, Section~3.2.) }

\validRule{fbc-20802}{A \GeneAssociation object may have the optional SBML
Level 3 Core subobjects for notes and annotations. No other elements
from the SBML Level 3 Core namespace are permitted on a \GeneAssociation.
(References: SBML Level~3 Version~1 Core, Section~3.2.) }

\validRule{fbc-20803}{A \GeneAssociation object may have the
optional attribute \token{fbc:\-id}. No other attributes from the SBML
Level~3 Flux Balance Constraints namespace are permitted on a \GeneAssociation
object. (References: SBML Level~3 Package Specification for Flux Balance
Constraints, Version~2, \sec{geneassociation-class}.) }

\validRule{fbc-20804}{The attribute \token{fbc:\-id} on a \GeneAssociation
must be of the data type \token{SId}. (References: SBML Level~3
Package Specification for Flux Balance Constraints, Version~2,
\sec{geneassociation-class}.) }

\validRule{fbc-20805}{A \GeneAssociation object must have one and only one
of the concrete \Association objects:  \Gene, \GeneAnd or \GeneOr. 
(References: SBML Level~3 Package Specification for Flux Balance 
Constraints, Version~2, \sec{geneassociation-class}.) }


\subsubsection*{Rules for \class{Gene} object}

\validRule{fbc-20901}{A \Gene object may have the optional SBML
Level 3 Core attributes \token{metaid} and \token{sboTerm}. No other
attributes from the SBML Level 3 Core namespace are permitted on a
\Gene. (References: SBML Level~3 Version~1 Core, Section~3.2.) }

\validRule{fbc-20902}{A \Gene object may have the optional SBML
Level 3 Core subobjects for notes and annotations. No other elements
from the SBML Level 3 Core namespace are permitted on a \Gene.
(References: SBML Level~3 Version~1 Core, Section~3.2.) }

\validRule{fbc-20903}{A \Gene object must have the required
attribute \token{fbc:\-reference} and may have the
...
permitted on a \Gene object. 
(References: SBML Level~3 Package Specification for Flux Balance
Constraints, Version~2, \sec{gene-class}.) }

\validRule{fbc-20904}{The attribute \token{fbc:\-reference} on a \Gene
must be of the data type \token{string}. (References: SBML Level~3
Package Specification for Flux Balance Constraints, Version~2,
\sec{gene-class}.) }

\validRule{fbc-20905}{The attribute \token{fbc:\-id} on a \Gene
must be of the data type \token{SId}. (References: SBML Level~3
Package Specification for Flux Balance Constraints, Version~2,
\sec{gene-class}.) }

\validRule{fbc-20906}{The attribute \token{fbc:\-species} on a \Gene
must be of the data type \token{SIdRef}. (References: SBML Level~3
Package Specification for Flux Balance Constraints, Version~2,
\sec{gene-class}.) }

\validRule{fbc-20907}{The attribute \token{fbc:\-species} on a \Gene
...
\Association objects: \Gene, \GeneAnd, or \GeneOr. No other 

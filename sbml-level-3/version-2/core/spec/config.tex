...
\else
  ...
  \newcommand{\vertwothreeline}[3]{\changed{#1} & \changed{#2} \par & \changed{#3} \\[3 pt]}
...
\newcommand{\sbmlrelease}  {\relverdiff{\changed{2}}{1} \changed{(Draft)}}
\newcommand{\sbmlreleaseNC}{\relverdiffNC{2}{1} (Draft)}
\newcommand{\sbmldate}     {\changed{XX June 2016}}

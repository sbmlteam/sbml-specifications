...
\end{equation}
\end{linenomath}
Let the value of the \token{multiplier} of $\{u_i\}$ be
...
consistency of units throughout the model. We are starting with the
equality between the quantity expressed in base units and the defined
units \unew.  
\begin{linenomath}
\begin{equation}
...
\begin{equation}
  \ybase \, \uone^{z_1} \utwo^{z_2} \ldots \un^{z_n}
    = \ynew \cdot m \cdot 10^p \uone^{x_1} \utwo^{x_2} \ldots \un^{x_n}
\label{eq:unit-equality}
\end{equation}
\end{linenomath}

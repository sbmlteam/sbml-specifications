...
\item We use red color in text and figures to indicate changes
  ...
  change has occurred inside them.  \relchange{In UML diagrams, a red box is used to indicate a deletion, and red text to indicate a semantic change or addition.}

...
developers.  As in many projects, the primary \relchange{medium for
  interactions} between members is electronic \relchange{messaging}.
Discussions about SBML take place on the \relchange{combination web
...
list are available at \relchange{the same location}.

A low-volume, broadcast-only \relchange{web forum/}mailing list is
...
used for advertising and its \relchange{membership} will never be
disclosed.  \emph{It is vitally important that all users of SBML
  stay informed about new releases and other developments by
  subscribing to
  \relchange{\link{https://groups.google.com/d/forum/sbml-announce}{sbml-announce}}},
even if they do not wish to participate in \relchange{discussions on
  \link{https://groups.google.com/d/forum/sbml-discuss}{sbml-discuss}}.
Please visit
\link{http://sbml.org/Forums/}{sbml.org/Forums/}
for information about how to subscribe to \relchange{the list} as
...
\link{https://groups.google.com/d/forum/sbml-announce}{https://groups.google.com/d/forum/sbml-announce}
\relchange{web forum and} mailing list.
...
\item We use red color in text and figures to indicate changes
  between this version of the specification\relchange{, namely} SBML \thisLVR, and
  the \emph{most recent previous release} of the specification
  (which, for the present case, is SBML Level~\relchange{3} Version~\relchange{1} Core
  \emph{\relverdiff{\relchange{Release 1}}{Release 2}}).  The changes may be either
  additions or deletions of text; in the case of deletions, entire
  sentences, paragraphs or sections are colored to indicate a
  change has occurred inside them.  \relchange{In UML diagrams, a red \emph{box} is used to indicate a deletion, and red \emph{text} to indicate a semantic change or addition.}

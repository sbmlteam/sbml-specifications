...
\Dimensions, \ListOfCompartmentGlyphs, \ListOfSpeciesGlyphs, 
...
\textsf{\textbf{ListOf\rule{0.15in}{0.5pt}}} subobjects within a \Layout 
...
on the \Layout, it must not be empty: \ListOfCompartmentGlyphs, 
\ListOfSpeciesGlyphs, \ListOfReactionGlyphs, \ListOfTextGlyphs, 
\ListOfAdditionalGraphicalObjects.  
(References: SBML Level~3 Package Specification for Layout, 
Version~1, \sec{layout-class}.) }

\validRule{layout-20305}{A \Layout object must have the required attribute 
...
\validRule{layout-20403}{There may be at most one instance of an \BoundingBox 
...
\validRule{layout-20406}{The value of a \token{layout:\-metaidRef} of 
...
\validRule{layout-20708}{The value of a \token{layout:\-reference} 
...
\validRule{layout-21203}{A \Dimensions object must have the required 
...
\validRule{layout-21204}{The attributes \token{layout:\-width}, 

...
%
\newtxt{Note that the LP format expression of the quadratice terms is written as $\frac{2*R2^2}{2}$ and it is left to the implementing tool to make any necessary translation of the quadratic terms to the required native solver format.}

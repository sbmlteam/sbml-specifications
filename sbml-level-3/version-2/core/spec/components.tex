...
\Constraint inherits an optional \token{id} attribute from \SBase, of type \primtype{SId}.  The identifier of a \Constraint object has no mathematical meaning in a model.

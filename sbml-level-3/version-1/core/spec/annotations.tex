...
format for the content of \Annotation objects
...
\item \token{bqmodel:isDerivedFrom} The modeling object represented 
	by the component of the encoded model is derived from the 
	modeling object represented by the referenced resource. For 
	instance, they can be the fruit of a refinement or their 
...
\item \token{bqbiol:isPropertyOf} The biological entity represented 
	by the model component is a property of the referenced resource.

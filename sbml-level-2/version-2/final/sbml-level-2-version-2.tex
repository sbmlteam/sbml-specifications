...
(narrow) term that matches the form of the \InitialAssignment.
...
SBO term.  The SBO term chosen should be the most precise (narrow)
term that matches the form of the \Rule.
...
\Species element represents the concept of a biochemical
...
are used to enclose a set of \token{rdf:li} elements.  These
elements are either \token{dc:element}\citep{beckett:2002} or a
subset of \token{dcterms:*} elements~\citep{kokkelink:2002}. The
valid set of \token{dcterms:*} elements consists of
\token{dcterms:hasPart}, \token{dcterms:isPartOf},
\token{dcterms:isVersionOf}, \token{dcterms:hasVersion} and
\token{dcterms:isReferencedBy}. The broad semantics of these
elements is defined by the qualified Dublin Core.  The format
adopts a semantics for \token{dc:relation} that is significantly
more constrained than that defined by the Dublin Core standard:
\token{dc:relation} represents the case where the object
...
\item \token{dc:relation} The object represented by the SBML
component is the subject of the referenced resource

\item \token{dcterms:hasPart} The object represented by the SBML
component includes the subject of the referenced resource, either
physically or logically

\item \token{dcterms:isPartOf} The object represented by the SBML
component is a physical or logical part of the subject of the
referenced resource

\item \token{dcterms:isVersionOf} The object represented by the
SBML component is a version or an instance of the subject of the
referenced resource

\item \token{dcterms:hasVersion} The subject of the referenced
resource is a version or an instance of the object represented by
the SBML component

\item \token{dcterms:isReferencedBy} The object represented by the

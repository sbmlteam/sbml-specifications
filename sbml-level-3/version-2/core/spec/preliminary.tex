...
\vertwo{Packages created and designed for use with \sbmlthree Version~1 may be used in \sbmlthree Version~2 documents, and be interpreted in exactly the same manner as before.  They may not, however, take advantage of the new features and constructs in Version~2.  This means the following:}
...
\itemvertwo{An \primtype{SIdRef} type value in a \sbmlthree Version~1 package may not be used to reference an element from Level~3 Version~2 Core that has an \primtype{SId} in SBML Level~3 Version~2 but did not have one in Version~1.}

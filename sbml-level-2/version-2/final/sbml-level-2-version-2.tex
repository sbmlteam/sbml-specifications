...
(I.e., a \token{lambda} element cannot contain another
...
\FunctionDefinition{}s defined earlier in the model, or predefined
MathML functions, operators, and constants.  This implies that
functions must be written so that all variables or parameters they
may need are passed to them via their function parameters.
\end{blockChanged}
...
Equation~\ref{eq:single-unit-no-offset}:
\begin{align}
  \xold \uold &= \xnew \, \unew

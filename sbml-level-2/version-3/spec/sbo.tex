...
formats, using} \changed{a deeper semantics.  Although} an advanced software
...
\changed{not all SBO terms can} \changed{be used to annotate all
...
SBO that apply to that component.  \changed{(There are currently
  no} \changed{specific SBO term that correspond to the \Sbml,

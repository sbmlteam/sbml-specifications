...
\Delay, and \token{math} in \EventAssignment.  (References: \tworefs{4.8, 4.9, 4.11, and 4.12}{\ref{sec:initialAssignment}, \sec{sec:rules}, \sec{sec:reactions}, and~\sec{sec:events}}.)

...
\textcolor{blue}{\validRule{qual-20413}{No element of the \ListOfFunctionTerms object can cause the \emph{level} of a \QualitativeSpecies to exceed the value \token{qual:-maxLevel} attribute.  (References: SBML Level~3 Package
  Specification for Qualitative Models, Version~1,
  \sec{math-interpret}.) }}

\textcolor{blue}{\validRule{qual-20414}{No element of the \ListOfFunctionTerms object can cause the \emph{level} of a \QualitativeSpecies to become negative.  (References: SBML Level~3 Package
  Specification for Qualitative Models, Version~1,
  \sec{math-interpret}.) }}

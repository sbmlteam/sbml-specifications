...
We also would like to thank (in alphabetical order) \newtxt{Andreas Dr\"{a}ger, Ali Ebrahim}, \newtxt{Ronan Fleming}, Ben Heavner, Daniel Hyduke, Nicolas Le Nov\`{e}re, \newtxt{Chris Myers, Nicolas Rodriguez}, Kieran Smallbone, Lucian Smith, Neil Swainston, \newtxt{Alex Thomas, other members of the \textsf{FBC Package Working Group}, the libSBML and JSBML development teams and all others who contributed to discussions on various occasions.}

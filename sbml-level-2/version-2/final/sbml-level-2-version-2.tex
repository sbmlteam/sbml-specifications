...
\item A new unit defined in a \UnitDefinition, and
...
this approach may be more efficient and more portable to other
...
initial assignment definition, the value must be a valid SBO term
identifier.  The \InitialAssignment object should have a ``is a''
...
mathematical formula term defined in SBO (\ie terms derived from
...
initial value $2y$, where $y$ is an identifier defined elsewhere
in the model:
...
\begin{align*}
  ...
  \D\frac{d Y1_n}{d t} &= \D\frac{k_1 X Y1_n V_n - k_T (Y1_n - Y1_c) V_c}{V_n}
    && \text{reactions production and transport} \\[5pt]
  \D\frac{d Y1_c}{d t} &= \D\frac{k_T (Y1_n - Y1_c) V_c - k_2 Y1_c Y2 V_c}{V_c}
    && \text{reactions transport and transformation} \\[5pt]
  \D\frac{d Y2}{d t}   &= \D\frac{k_2 Y1_c Y2 V_c - k_3 Y2 V_c}{V_c} 

...
% $Id: annotations.tex 12141 2010-10-06 05:04:18Z mhucka $
% $HeadURL: https://svn.code.sourceforge.net/p/sbml/code/trunk/specifications/sbml-level-3/version-1/core/spec/annotations.tex $
% ----------------------------------------------------------------
...
\changed{\url{http://biomodels.net/qualifiers/}}) embedded in the XML form
...
this might correspond to the URI \uri{urn:miriam:uniprot:P12999}.
...
identifier \uri{urn:miriam:uniprot:P12999}, thereby identifying
...
\item \uri{ttp://www.ebi.ac.uk/intenz/query?cmd=SearchEC\&ec=3.5.4.4}
...
at the address \changed{\url{http://biomodels.net/qualifiers}}.  Each
...
\begin{table}[b]
  ...
  \caption{BioModels.net qualifiers at the time of this writing, and a
    ...
    \changed{\url{http://biomodels.net/qualifiers/}.  (The

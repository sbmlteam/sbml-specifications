...
As explained in \sec{sec:ruleconstraints}, an SBML model
...
approach described in \sec{sec:ruleconstraints}.  The
...
\item{} [Corresponding to step 1(b)
  in \sec{sec:overdetermined-method}.] \emph{Every
...
\item{} [Corresponding to step 1(e)
  in \sec{sec:overdetermined-method}.] \emph{Every \KineticLaw

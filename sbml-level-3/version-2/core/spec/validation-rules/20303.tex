...
SBML functions are not permitted to be recursive \relchange{or mutually recursive}.  (References: \tworefs{3.4.3 and 4.3.2}{\ref{sec:ci-token} and~\ref{sec:function-definition-math}}.)

...
\newcommand{\LocalParameters}{\defRef{LocalParameter}{subsec:localparameter}}
...
\newcommand{\Reactions}{\defRef{Reaction}{sec:reactions}}
...
\newcommand{\UnitDefinitions}{\defRef{UnitDefinition}{sec:unitdefinitions}}

...
\newcommand{\sbmlone}{SBML Level~2\xspace}
...
\item Each \changed{\Reaction instance} (see
  ...
  namespace for new local parameter identifiers.  Within the
...
\begin{figure}[htb]
  \centering
  \includegraphics[scale = 0.68]{figs/unitdefinition}
...
\begin{figure}[htb]
  \centering
  \includegraphics[scale = 0.68]{figs/specie}
...
\begin{figure}[htb]
  \begin{blockChanged}
  \centering
  \includegraphics[scale = 0.68]{figs/constraint}
...
\begin{figure}[htb]
  \centering
  \includegraphics[scale = 0.68]{figs/event}
...
\begin{center}
\includegraphics[scale = 0.9]{figs/example-network}
\end{center}
...
\begin{figure}[htb]
  \vspace*{20pt}
  \centering
  \includegraphics[scale=0.67]{figs/multicomp}
...
% FIXME: MH not reviewed this section
...
\item[9999.] In a MathML element outside a
...
\item[9999.] A \token{ci} element that represents a math
...
\item[9999.] The \token{lambda} elements can only be used as the outer
...
\item[9999.] MathML operators return results of two types: boolean and
...
\item[9999.] Boolean operators and values can optionally be used as the root of
...
% FIXME what's going on with these?  Are these bogus?  Why are
% they here?
%
...
\item[9999.] The directed graph formed from unit definitions must be
...
\sbmlrule{1401}
\sbmlrule{1402}
\sbmlrule{1403} % FIXME is it supposed to be here?
\sbmlrule{1404}
\sbmlrule{1405}
\sbmlrule{1406}
\sbmlrule{1407}
...
% FIXME shouldn't there be a 1704 that's like 1703 but talks about RateRule?

% FIXME decide what to do about the following:

\item[9999.] The combined set of \token{initialAssignment},

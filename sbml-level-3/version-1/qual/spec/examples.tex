...
\label{sub:ex_phage}
This last example is the multi-valued, logical model as defined in \cite{thieffry} for the core network controlling the decision between lysis and lysogenization in temperate bacteriophage. 

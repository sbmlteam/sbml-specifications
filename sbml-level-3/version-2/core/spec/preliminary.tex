...
\item Each \Reaction instance (see \sec{sec:reactions})
  ...
  outside of that reaction.  \changed{Conversely, local parameters in a given \Reaction object are not visible outside of that reaction.  To support this, \LocalParameter's \token{id} attribute has type \primtype{LocalSId} (\sec{sec:localsid}) rather than \primtype{SId}.}  

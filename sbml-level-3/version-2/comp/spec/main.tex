...
\packageVersion{Version 1, \begin{blockChanged}Release 3\end{blockChanged}}
\packageVersionDate{\begin{blockChanged}14 November 2013\end{blockChanged}}
\packageGeneralURL{http://sbml.org/Documents/Specifications/SBML_Level_3/Packages/comp}
\packageThisVersionURL{http://identifiers.org/combine.specifications/sbml.level-3.version-1.comp.version-1.release-3}

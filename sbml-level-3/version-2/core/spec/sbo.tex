...
attribute's value must be an identifier \relchange{that refers}
...
hierarchically-structured set of controlled vocabularies with \relchange{seven}
main divisions: (1) \relchange{physical} entity \relchange{representation}, (2) participant role, (3) \relchange{systems description} parameter, (4) modeling framework, (5)
mathematical expression, (6) \relchange{occurring entity representation}, \relchange{and (7) metadata representation}.  \fig{fig:sbo-top-level} illustrates
the highest level of SBO.

Each of the \relchange{seven} branches of \fig{fig:sbo-top-level} has a
...
consistent with future versions of SBO.  \relchange{It reflects SBO as it existed in December, 2015.}  The web site for SBO
...
\begin{figure}[tbh]
  \centering
  \relverdiff{\includegraphics[scale=0.8]{figs/sbo-top-level}}
             {\includegraphics[scale=0.8]{figs/sbo-top-level-l3v2}}
  \vspace*{1ex}
  \caption{The \relchange{seven} controlled vocabularies (CVs) that
      make up the main branches of SBO.}
  \label{fig:sbo-top-level}
\end{figure}

\fig{fig:expanded-species} shows the structure for the
\emph{\relchange{physical} entity \relchange{representation}} branch, which reflects the hierarchical groupings of
...
\begin{figure}[htb]
  \centering
  \vspace*{-1ex}
  \relverdiff{\includegraphics[scale=0.8]{figs/sbo-entity}}
...
\begin{figure}[htb]
  \centering
  \relverdiff{\includegraphics[scale=0.8]{figs/sbo-participant-role}}
...
\begin{figure}[tbh]
  \centering
  \vspace{-2ex}
  \relverdiff{\includegraphics[scale=0.8]{figs/sbo-quantitative-parameter}}
...
The terms of the SBO quantitative \relchange{systems description} parameter branch contain
...
this branch, which is at this point \relchange{fairly}  simple, but we
expect that more terms will evolve in the future.

\begin{figure}[tbh]
  \centering
  \vspace{-1ex}
  \relverdiff{\includegraphics[scale=0.8]{figs/sbo-framework}}
...
\begin{figure}[tbh]
  \centering
  \vspace*{-1ex}
  \relverdiff{\includegraphics[scale=0.8, trim=10 0 0 0]{figs/sbo-math-expression}}
...
references to terms in the SBO \emph{\relchange{systems description} parameter} \relchange{branch} (for
\token{k} \relchange{and} \token{R}).  This makes it
...
The \emph{\relchange{occurring entity representation}} branch of SBO defines types of biological
...
\begin{figure}[tbh]
  \centering
  \relverdiff{\includegraphics[scale=0.8]{figs/sbo-interaction}}
             {\includegraphics[scale=0.8]{figs/sbo-interaction-l3v2}}
  \caption{Partial expansion of some of the terms in the \emph{\relchange{occurring entity representation}} branch.}
...
\begin{figure}[htb]
  \centering
  \relverdiff{\includegraphics[scale=0.8]{figs/sbo-annotation}}
             {\includegraphics[scale=0.8]{figs/sbo-annotation-l3v2}}
  \caption{\relchange{Current expansion of the terms in the
    \emph{annotation} branch of SBO (under \emph{metadata representation}).}}
  \label{fig:sbo-annotation}
\end{figure}

\relchange{The controlled vocabulary for annotations is illustrated in \fig{fig:sbo-annotation}, the single child of the \emph{metadata representation} branch of SBO.  As this branch is for annotating annotations themselves, its branches cannot usually be used for \SBase-derived objects, as those generally depict basic model information, and not annotations of that model.  However, there are packages which may be able to use this branch of SBO:  the \val{port} element exactly corresponds to the \class{Port} class from the SBML Level~3 Hierarchical Model Composition package, for example.}
...
\begin{table}[ht]
  ...
  \begin{tabular}{lll}
    ...
    \Parameter          & quantitative \relchange{systems description} parameter    	& \sboparameterID \\
    ...
    \LocalParameter     & quantitative \relchange{systems description} parameter    	& \sboparameterID \\

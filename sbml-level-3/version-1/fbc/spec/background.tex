...
%
\newtxt{A widely used example of such an annotation is the `gene association' used to investigate the effect of gene deletions on a metabolic network.}
%
...
variables behavior in time. \newtxt{In contrast, the \FBCPackage considers a model at steady state and therefore time invariant and uses \Parameter elements to define the allowable range that a steady-state flux can attain. Therefore flux bounds and \SBML \Constraint elements should be considered independent to one another.}

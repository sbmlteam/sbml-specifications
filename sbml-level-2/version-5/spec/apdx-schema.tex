...
<xsd:schema targetNamespace="http://www.sbml.org/sbml/level2/version5"
    ...
    version="$ Id: sbml.xsd 22408 2015-08-04 00:00:36Z mhucka $">
    <xsd:import namespace="http://www.w3.org/1998/Math/MathML"
        schemaLocation="http://www.w3.org/Math/XMLSchema/mathml2/mathml2.xsd"/>
    <xsd:annotation>
        <xsd:documentation>
 * Filename   : sbml.xsd
 * Description: XML Schema for SBML Level 2 Version 5.
 * Author(s)  : Michael Hucka, Sarah Keating
 * Revision   : $ Id: sbml.xsd 22408 2015-08-04 00:00:36Z mhucka $
 * 
    ...
    <xsd:complexType name="Sbml">
        <xsd:complexContent>
            <xsd:extension base="SBase">
                ...
                <xsd:attribute name="version" type="xsd:positiveInteger" use="required" fixed="5"/>
            </xsd:extension>
        </xsd:complexContent>
    </xsd:complexType>

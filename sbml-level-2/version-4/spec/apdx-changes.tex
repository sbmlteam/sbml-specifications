...
% in functiondefition: moved last P in 4.3.2 (aobut units) to new
% section about calling functions

% added secction 4.3.4 in functiondefiniton, and paragraph about
% number of args

% added rule 10219

% sec 4.7.7 on compartments: removed requirement on ordering of 'outside'

% compartments: require size

% compartments: clarify outside doensn't mean sizes contained

% compartments: clarified the nature of inside/outside
% relationships and the fac they're not containment

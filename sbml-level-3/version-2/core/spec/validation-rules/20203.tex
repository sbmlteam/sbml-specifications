\changed{(This validation rule does not apply in SBML \thisLV.)}\footnote{\changed{Original rule:  ``The various \token{listOf\_} container objects in a \Model instance are

...
types~\citep{biron:2000}.  More specifically we make use of \primtype{integer}, \primtype{double}, \primtype{string}, and \primtype{SId}.

\subsection{The Dimension class}

%% TODO: REMOVE ORDER AND ATTRIBUTE FOR ORDER
%% TODO: CLASS EXTENDS SBASE
...
%% TODO: REMOVE ORDER AND ADD ATTRIBUTE FOR ORDER
%% TODO: CLASS EXTENDS SBASE
%% TODO: ADD ATTRIBUTE ABOUT WHAT IS BEING INDEXED

% <species id="S1" compartment="C1" conversionFactor="P1">
%  <listOfListOfIndices>
%    <listOfIndices attribute="compartment">
%      <!--the particular indices for the compartment-->
%    </listOfIndices>
%    <listOfIndices attribute="conversionFactor">
%      <!--the particular indices for the conversionFactor-->
%    </listOfIndices>
% </listOfListOfIndices>

% <species id="S1" compartment="C1" conversionFactor="P1">
%  <listOfIndices>
%    <index attribute="compartment" dim="0">
%       -- some math ---
%    </index>
%    <index attribute="compartment" dim="1">
%       -- some math ---
%    </index>
%    <index attribute="conversionFactor" dim="0">
%       -- some math ---
%    </index>
%    <index attribute="conversionFactor" dim="1">
%       -- some math ---
%    </index>
% </listOfIndices>

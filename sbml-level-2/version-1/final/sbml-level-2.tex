...
SBML was originally created partly by studying the modeling facilities in
...
%%%%%%%%% the units on the species definition?
  ...
  The units of \quantity{substance}, \quantity{volume}, \quantity{area} and
  \quantity{length} are determined from the built-ins \unit{substance},
  \unit{volume}, \unit{area} and \unit{length}, respectively, of
...
\attrib{size} has the default units of \unit{volume}, \unit{area},
\unit{length} and \unit{dimensionless}, respectively.  (See
Table~\vref{tab:builtin} and Table~\vref{tab:unitkind}.)  A missing value
...
spatial dimensions of the compartment.
...
\item \emph{Case of \attrib{initialConcentration} being used}.  The value
  ...
  absent, the units default to \unit{substance}/\unit{volume},
  \unit{substance}/\unit{area} or \unit{substance}/\unit{length} units,
  depending on whether the species' compartment has spatial dimensions of
  3, 2 or 1, respectively.  \unit{substance}, \unit{volume}, \unit{area}
  and \unit{length} are taken from Table~\vref{tab:builtin}.  (As noted
...
\quantity{length} are built-in unit types (see Table~\vref{tab:builtin}).
...
\item \emph{In the case of a species}, a \class{RateRule} sets the rate of
  ...
  ``\attribvalue{2}'' or ``\attribvalue{1}'', respectively.  If the
  compartment's \attrib{spatialDimensions} field has a value of
  ``\attribvalue{0}'', then the rule's units are \quantity{substance/time}.
  (Once again, the term ``concentration'' is being used somewhat loosely.)
...
substance and time for the reaction.  If these fields are not set in a
...
Table~\vref{tab:builtin}.  The expression in \attrib{math} may refer to
...
%-----------------------------------------------------------------------------
\subsection{Example Involving \class{RateRule} and Combinations of

...
container.  SBML Level~2 Version~4 places the following
...
\begin{blockChanged}
  ...
  \item Any element with mathematical meaning with no \InitialAssignment or \Rule that targets it continues to have its initial value, as defined by the relevant attribute, but may now be overridden by any fast \Reaction, executed as above.

...
to work seamlessly with other SBML Level~3 packages. For example any 
objects are entirely encapsulated and any extensions to existing SBML 
classes are defined as optional.

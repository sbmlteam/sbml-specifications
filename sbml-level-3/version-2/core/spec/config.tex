...
\newcommand{\sbmlversionnum}{\relverdiff{1}{2}}
\newcommand{\sbmlrelease}  {\relverdiff{2}{1} \changed{(Draft)}}
...
\newcommand{\sbmlSchemasURL}{\url{http://sbml.org/specifications/sbml-level-\sbmllevel/version-\sbmlversionNC/schemas/}}

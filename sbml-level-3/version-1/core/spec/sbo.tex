...
of controlled vocabularies with six main divisions: (1) entity, (2) participant role, (3) quantitative parameter, (4) modeling framework, (5)
...
not belong to the \emph{functional entity} branch, representing the function of 
...
quantitative parameters is decomposition into different versions

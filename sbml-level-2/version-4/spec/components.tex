...
Values of this attribute must be chosen from
  identifiers referring to an interaction defined in SBO
(\ie terms derived from \sboevent).  The SBO term chosen
...
the value must be an SBO identifier referring to a \changed{material entity} (\ie terms derived from \sbomaterialentity).

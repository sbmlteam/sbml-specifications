...
\newif\ifrevtwospec
\global\let\ifrevtwospec\iffalse
\RequirePackage[dummyoption]{optional}
\opt{l3v1r2}{\global\let\ifrevtwospec\iftrue}
...
\ifrevtwospec
  ...
  \newcommand{\subsubsectionRelChange}[1]{%
...
\else
  ...
  \newcommand{\subsubsectionVerChange}[1]{%
    \colorlet{@currentsectionnumcolor}{@sectionnumcolor}%
    \colorlet{@sectionnumcolor}{sbmlchangedcolor}%
    \subsubsection{#1}%
    \colorlet{@sectionnumcolor}{@currentsectionnumcolor}}

...
analysis to assess this \changed{condition} for the system of equations implied by a
...
\changed{despite our use of a differential equation framework for
  this explanation, it should be understood that this}
\changed{use of ODEs has no implication about the framework
...
\item For each of the following, create one edge:
  ...
  \item Every vertex created in step 1(b) to the particular vertex
    ...
    referenced by the \token{variable} \changed{attribute} of the rule

...
\begin{figure}[h!]
  ...
  \includegraphics[width=0.85\textwidth]{images/v2harmony_fbc_uml.pdf}\\
...
\GeneProduct (\ref{geneproduct-class}) \FluxBound (\ref{fluxbound-class}), \FluxObjective (\ref{fluxobjective-class}) 
and \Objective (\ref{objective-class}) classes. In the FBC package the 
...
Hill system order \cite{hillsystem, hillwikipedia}.

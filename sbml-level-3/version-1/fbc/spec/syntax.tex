...
\begin{itemize}
	...
	\item { A \Reaction \token{lowerFluxBound} attribute \newtxt{may not point to a \Parameter with a \token{value} of \val{INF}.}}
	\item { A \Reaction \token{upperFluxBound} attribute \newtxt{may not point to a \Parameter with a \token{value} of \val{-INF}.}}

...
A low-volume, broadcast-only \changed{web forum/}mailing list is
...
used for advertising and its \changed{membership} will never be
disclosed.  \emph{It is vitally important that all users of SBML
  stay informed about new releases and other developments by
  subscribing to
  \changed{\link{http://sbml.org/Forums/sbml-announce}{sbml-announce}}},
even if they do not wish to participate in \changed{discussions on
  \link{http://sbml.org/Forums/sbml-discuss}{sbml-discuss}}.
Please visit
\link{http://sbml.org/Forums/sbml-announce}{sbml.org/forums/sbml-announce}
for information about how to subscribe to \changed{the list} as
...
\link{http://sbml.org/specifications/sbml-level-\sbmllevel/version-2/core/errata/}{http://sbml.org/}
\link{http://sbml.org/specifications/sbml-level-\sbmllevel/version-2/core/errata/}{specifications/sbml-level-\sbmllevel/version-2/core/errata/}.
...
\item We use red color in text and figures to indicate changes
  ...
  \emph{\changed{Release 1}}).  The changes may be either
  additions or deletions of text; in the case of deletions, entire
  sentences, paragraphs or sections are colored to indicate a
  change has occurred inside them.  \changed{In UML diagrams, a red box is used to indicate a deletion, and red text to indicate a semantic change or addition.}
...
% braces (\{ \}).  \fig{fig:sbase} gives an example of this.
%

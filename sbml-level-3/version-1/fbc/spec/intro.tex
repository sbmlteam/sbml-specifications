...
\end{description}
Details of earlier independent proposals are described in \ref{background}.
...
The Flux Balance Constraints package has no dependencies on other
SBML Level~3 packages.  It is also designed with the goal of being able
to work seamlessly with other SBML Level~3 packages. For example the new elements are entirely encapsulated in their own \sf{ListOf} classes and any extensions to existing SBML classes are defined as optional.

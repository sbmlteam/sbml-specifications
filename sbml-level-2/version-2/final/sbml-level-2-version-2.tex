...
\newcommand{\RateRule}{\defRef{RateRule}{sec:rules}}
\newcommand{\AlgebraicRule}{\defRef{AlgebraicRule}{sec:rules}}
\newcommand{\AssignmentRule}{\defRef{AssignmentRule}{sec:rules}}
...
\newcommand{\KineticLaw}{\defRef{KineticLaw}{sec:reactions}}
\newcommand{\SimpleSpeciesReference}{\absDefRef{SimpleSpeciesReference}{sec:reactions}}
\newcommand{\SpeciesReference}{\defRef{SpeciesReference}{sec:reactions}}
\newcommand{\ModifierSpeciesReference}{\defRef{ModifierSpeciesReference}{sec:reactions}}
...
\item \sbmltwotwo corrects numerous errata discovered in
  ...
  errata are listed in Section~\ref{apdx:version1-version2}.  As a
  result of changes to \sbmltwo implied by these errata, some
  existing \sbmltwoone models, even when modified as explained
  above, may still not be compliant with Version~2.  The ultimate
  impact of the changes depends on the specific features used by a
  given model and the assumptions under which the model was
  created.

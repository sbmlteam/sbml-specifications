...
\begin{example}
  <spatial:listOfGeometryDefinitions>
    <spatial:sampledFieldGeometry spatial:isActive="true" spatial:sampledField="imgtest">
  ...
  <spatial:listOfSampledFields>
    <spatial:sampledField spatial:id="imgtest" spatial:dataType="uint8" spatial:numSamples1="51"

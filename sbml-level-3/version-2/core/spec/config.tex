...
\newcommand{\sbmlrelease}  {\relverdiff{\changed{2}}{1} \changed{(Release Candidate 1)}}
\newcommand{\sbmlreleaseNC}{\relverdiffNC{2}{1}-rc1}
\newcommand{\sbmldate}     {\changed{15 September 2016}}

...
% $Id: config.tex 12143 2010-10-06 05:18:04Z mhucka $
% $HeadURL: https://svn.code.sourceforge.net/p/sbml/code/trunk/specifications/sbml-level-3/version-1/core/spec/config.tex $
% -----------------------------------------------------------------------------
...
\newcommand{\sbmldate}     {\changed{22 April 2014}}

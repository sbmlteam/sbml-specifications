...
<listOfUnitDefinitions>
    <unitDefinition id="degree_Fahrenheit">
        ...
        <listOfUnits>
            <unit kind="dimensionless" multiplier="5" scale="0" exponent="1"/>
            <unit kind="kelvin"        multiplier="9" scale="0" exponent="-1"/>
        </listOfUnits>
    </unitDefinition>
    <unitDefinition id="per_kelvin">
        <notes><p xmlns="http://www.w3.org/1999/xhtml">
            \textcolor{gray}{\emph{This is used as a denominator term, as the unit of the
            explicit 9/5 rescaling factor used to complete the function
            definition.}}
        </notes>
        <listOfUnits>
            <unit kind="kelvin" multiplier="1" scale="0" exponent="-1"/>
        </listOfUnits>
    </unitDefinition>
</listOfUnitDefinitions>
...
<listOfFunctionDefinitions>
    <functionDefinition id="Fahrenheit_to_kelvin">
        <notes><p xmlns="http://www.w3.org/1999/xhtml">
            \textcolor{gray}{\emph{This function takes a number assumed to be in Fahreinheit 
        ...
        <math xmlns="http://www.w3.org/1998/Math/MathML"
            ...
            <lambda>
                ...
                <apply>
                    ...
                    <cn sbml:units="per_kelvin"> 1.8 </cn>
                </apply>
            </lambda>
        </math>
    </functionDefinition>
...
\end{example}
  \caption{SBML fragment showing a candidate definition of a
    function to convert Fahrenheit temperature to units kelvin,
    along with necessary unit definitions to make the definition
    complete.}
    \label{fig:ftok}
\end{figure}

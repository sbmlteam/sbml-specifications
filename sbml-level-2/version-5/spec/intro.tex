...
\textbf{L}anguage (SBML) \thisLV Release~\sbmlrelease, a model
...
developers.  As in many projects, the primary \changed{medium for
  interactions} between members is electronic \changed{messaging}.
Discussions about SBML take place on the \changed{combination web
  forum and mailing list}
\link{http://sbml.org/Forums/sbml-discuss}{sbml.org/forums/sbml-discuss}.
The mailing list archives and a web-browser-based interface to the
list are available at \changed{the same location}.

A low-volume, broadcast-only \changed{web forum/}mailing list is available
where notifications of revisions to the SBML speci\-fication, notices of
votes on SBML technical issues, and other critical matters are announced.
This list is
\link{http://sbml.org/Forums/sbml-announce}{sbml.org/forums/sbml-announce}
and anyone may subscribe to it freely.  This list will never be used for
advertising and its \changed{membership} will never be disclosed.  \emph{It
  is vitally important that all users of SBML stay informed about new
  releases and other developments by subscribing to
  \changed{\link{http://sbml.org/Forums/sbml-announce}{sbml-announce}}}, even
if they do not wish to participate in \changed{discussions on
  \link{http://sbml.org/Forums/sbml-discuss}{sbml-discuss}}.  Please visit
\link{http://sbml.org/Forums/sbml-announce}{sbml.org/forums/sbml-announce}
for information about how to subscribe to \changed{the list} as well as for
...
language features.  The present document defines SBML \thisLVR.  In Section~\ref{sec:notation-color}
...
between SBML \thisLV and SBML \previousLVR.
...
SBML \thisLV since the publication of Release~1 is also
...
\link{http://sbml.org/Forums/sbml-announce}{sbml.org/forums/sbml-announce}
\changed{web forum and} mailing list.

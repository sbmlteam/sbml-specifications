...
\validRule{comp10101}{To conform to the  Hierarchical Model Composition
...
\validRule{comp10102}{When appearing in an SBML document, all elements
...
\validRule{comp10202}{(Extending the SBML Level~3 Version~1 Core

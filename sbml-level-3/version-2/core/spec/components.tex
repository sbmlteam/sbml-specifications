...
\begin{itemize}
  ...
  \itemvertwo{An element may be defined within a package to have mathematical meaning, and its ID may be used to determine one or more mathematical functions in core.}
\end{itemize}

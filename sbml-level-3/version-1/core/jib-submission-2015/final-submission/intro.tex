...
% $Id: intro.tex 12110 2010-10-02 03:03:15Z mhucka $
% $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/trunk/specifications/sbml-level-3/version-1/core/spec/intro.tex $
% ----------------------------------------------------------------
...
as \changed{their} users discover errors and ambiguities.  As a practical
...
allows for \changed{operators} as well as data attributes to be defined,
...
line \changed{is used} to refer to instances of the contained
...
only uses data attributes and not \changed{operators}, inheritance in SBML

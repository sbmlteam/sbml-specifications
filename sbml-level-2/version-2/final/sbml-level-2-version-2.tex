...
%Section~\ref{sec:examples} provides additional examples of using
%\token{notes} in different models.

%The question arises of what can be placed inside \token{notes}.
%Must it be an XHTML \token{<body>}?  Can it be another container
%such as \token{<p>}, \token{<table} or other?

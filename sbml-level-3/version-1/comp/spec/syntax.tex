...
\sect{extended-sbase-class}).  It inherits \SBase's attributes
...
\paragraph{The \hspace*{1pt}\token{id} and \token{name} attributes}
...
\primtype{SId}.  The optional attribute \token{name} may be used to give a human-readable identifier to \ExternalModelDefinition objects.  
...
\paragraph{The \hspace*{1pt}\token{id} and \token{name} attribute}
...
The optional attribute \token{name} may be used to give a human-readable identifier to \Port objects.  
...
The optional attribute \token{name} may be used to give a human-readable identifier to \Submodel objects.  
...
manipulated more directly by other submodels.  The optional attribute \token{name} may be used to give a human-readable identifier to \Deletion objects.

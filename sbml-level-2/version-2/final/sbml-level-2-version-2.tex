...
Version~2 elements must be encoded using this URI by assigning
\changed{it} to either the default \changed{XML} namespace as
shown above, or using a tag prefix on every element.
...
size may be a volume if the compartment is a three-dimensional
one, or it may be an area, or a length.

...
In SBML Level 2, only the former cases were definable, so all SBML Level 2 models can be read as defining `\token{persistent}=false' for all \Event \class{Trigger}s.

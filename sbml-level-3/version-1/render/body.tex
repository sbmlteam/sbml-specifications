...
%
%The \colorString primitive type is a string encoding the hexidecimal color code. For example, the string "\#000000" is the \colorString value representing the black.

...
% $Id: apdx-changes.tex 9429 2009-03-27 09:00:59Z mhucka $
% $HeadURL: https://svn.code.sourceforge.net/p/sbml/code/trunk/specifications/sbml-level-3/version-1/core/spec/apdx-changes.tex $
% ----------------------------------------------------------------

...
\uri{http://www.sbml.org/sbml-/level3/version1/fbc/version3}. as the XMLNamespace to use for elements of this package.
(References: SBML Level~3 Package Specification for Flux Balance
Constraints, Version~3, \sec{xml-namespace}.)}

\validRule{fbc-10102}{Wherever they appear in an SBML document, elements
and attributes from the \FBCPackage must use the
\uri{http://www.sbml.org/sbml/level3/version1/fbc/version3} namespace, declaring so either explicitly or implicitly.
(References: SBML Level~3 Package Specification for Flux Balance
...
instance of each of the \ListOfObjectives,

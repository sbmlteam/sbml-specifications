...
\changed{All annotations only add additional qualifying information, and never change existing information.  As such, they can be ignored without changing the (broader) meaning of the model.  The same is true of nested annotations (described below): these sub-annotations qualify their parent annotation, but never change the fundamental meaning of that annotation.}

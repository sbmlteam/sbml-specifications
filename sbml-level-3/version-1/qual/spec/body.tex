...
\primtype{UnitSIdRef}, and \primtype{string}. The Qualitative Model package also makes use of or defines other primitive types;
...
the \Transition  class are defined in Sections \sect{qualSpecies-class} and \sect{transitions} respectively.

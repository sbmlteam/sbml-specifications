...
\subsection{What's the difference between the \attrib{boundaryCondition}
  and \attrib{constant} attributes on species in Level~2?}
...
Hamid Bolouri is Professor of ??? at the
...
Japan Science And Technology Corporation's Exploratory Research for
Advanced Technology program (JST ERATO).

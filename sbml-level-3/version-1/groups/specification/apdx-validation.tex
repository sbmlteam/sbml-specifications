...
\validRule{groups-10302}{The value of a \token{groups:idRef} attribute on \Member objects must conform to the syntax of the SBML data type \primtype{SIdRef}.  (References: SBML Level~3 Package Specification for Groups, Version~1, \sec{member-class}.) }

% \validRule{groups-10303}{The value of a \token{groups:groupIdRef} attribute on \Member objects must conform to the syntax of the SBML data type \primtype{GroupIdRef}.  (References: SBML Level~3 Package Specification for Groups, Version~1, \sec{member-class}.) }

\validRule{groups-10302}{The value of a \token{groups:metaIdRef} attribute on \Member objects must conform to the syntax of the SBML data type \primtype{IDREF}.  (References: SBML Level~3 Package Specification for Groups, Version~1, \sec{member-class}.) }
...
\validRule{groups-20102}{A \ListOfGroups object within a \Model object is optional, but if present, must not be empty.  (References: SBML Level~3 Package Specification for Groups, Version~1, \sec{model-class}.) }
...
\validRule{groups-20202}{A \Group object must have the attribute \token{groups:kind} because it is a required attribute. (References: SBML Level~3 Package Specification for Groups, Version~1, \sec{group-class}.) }

\validRule{groups-20203}{The value of the \token{groups:kind} attribute on a \Group object must have one of the following values: \val{classification}, \val{partonomy}, or \val{collection}.  These are the only permitted values for the \token{groups:kind} attribute on \Group. (References: SBML Level~3 Package Specification for Groups, Version~1, \sec{group-class}.) }
...
\validRule{groups-20205}{A \ListOfMembers object within a \Group object is optional, but if present, must not be empty.  (References: SBML Level~3 Package Specification for Groups, Version~1, \sec{group-class}.) }
...
\validRule{groups-20201}{A \Member object must have a value for one (and exactly one) of the attributes \token{groups:idRef} or \token{groups:metaIdRef}.  No other attributes from the Groups namespace are permitted on a \Member object. (References: SBML Level~3 Package Specification for Groups, Version~1, \sec{member-class}.) }

\validRule{groups-20202}{The value of the \token{groups:idRef} attribute, if set on a given \Member object, must be the value of an \token{id} attribute on an existing object (other than a \Group object) in the SBML document.  (References: SBML Level~3 Package Specification for Groups, Version~1, \sec{member-class}.) }

% \validRule{groups-20203}{The value of the \token{groups:groupIdRef} attribute, if set on a given \Member object, must be the value of a \Group object's \token{id} attribute in the SBML document.  (References: SBML Level~3 Package Specification for Groups, Version~1, \sec{member-class}.) }

\validRule{groups-20203}{The value of the \token{groups:metaIdRef} attribute, if set on a given \Member object, must be the value of a meta identifier on an existing object in the SBML document.  (References: SBML Level~3 Package Specification for Groups, Version~1, \sec{member-class}.) }

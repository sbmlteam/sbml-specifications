...
\packageVersion{Version 3, Release 1, Proposal $1\alpha$}
...
% new in v3
\newcommand{\ListOfUserConstraints}{\defRef{ListOfUserConstraints}{listofuserconstraints-class}}
\newcommand{\UserConstraint}{\defRef{UserConstraint}{userconstraint-class}}
\newcommand{\ListOfUserConstraintComponents}{\defRef{ListOfUserConstraintComponents}{listofuserconstraintcomponents-class}}
\newcommand{\UserConstraintComponent}{\defRef{UserConstraintComponent}{userconstraintcomponent-class}}
\newcommand{\ListOfKeyValues}{\defRef{ListOfKeyValues}{listofkeyvalues-class}}
\newcommand{\KeyValue}{\defRef{KeyValue}{keyvalue-class}}

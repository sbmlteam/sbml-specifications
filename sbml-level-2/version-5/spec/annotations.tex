...
Core~\citep{DCMI:2003} and \begin{blockChanged}BioModels qualifier elements (see
\url{http://sbml.org/miriam/qualifiers})\end{blockChanged} embedded in
...
composed as \token{resource:id}. \begin{blockChanged}The MIRIAM Resources facility located at
\url{http://sbml.org/miriam} lists URI syntaxes and
possible physical links to controlled vocabularies and databases.\end{blockChanged}
...
parser) of the relation elements is defined by \begin{blockChanged}the URI list at
\url{http://sbml.org/miriam}, and thus is outside the
scope of SBML.\end{blockChanged} The URI list generally assumes that the biological
...
The complete list of the qualifier elements in the \begin{blockChanged}BioModels
qualifier namespaces is documented at
\url{http://sbml.org/miriam/qualifiers}.\end{blockChanged} The list is
divided into two namespaces one for \begin{blockChanged}biological\end{blockChanged} qualifiers
\uri{http://biomodels.net/biology-qualifiers/} (prefix used here
\token{bqbiol}) and the other for \begin{blockChanged}model\end{blockChanged} qualifiers
\uri{http://biomodels.net/model-qualifiers/}) (prefix used here
\token{bqmodel}\begin{blockChanged})\end{blockChanged}.  This list will only grow i.e no element will be

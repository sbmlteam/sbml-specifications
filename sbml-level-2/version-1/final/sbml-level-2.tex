...
\begin{figure}[hb]
  ...
  \caption{A UML diagram of the inheritance hierarchy of major data types
    ...
    \class{listOf} lists) are also derived from \class{SBase}.}
  \label{fig:top-level}
\end{figure}
...
\texttt{\&x1A;}, can be used.  No restrictions as to the content of
\attrib{name} fields are imposed by SBML beyond those defined by the
\class{string} type of XML Schema.
...
units of all SBML mathematical entities apart from parameters.

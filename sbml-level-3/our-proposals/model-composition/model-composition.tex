...
\class{Model} structure.  A \class{Instance} structure simply represents a copy of
...
created.  A model can contain a set of \class{Link} elements which contain 2
\class{ObjectRef}
...
value (e.g. \attrib{initialAmount} on

...
Compatibility note: in \sbmltwoone, \UnitDefinition had an
...
\token{offset} field on \UnitDefinition and describing recommended
...
\item \emph{\UnitDefinition no longer has an \token{offset}
    field}.  In Version 2, the \token{offset} field on
  \UnitDefinition has been removed because it was impossible to

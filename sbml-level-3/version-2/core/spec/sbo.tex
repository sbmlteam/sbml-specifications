...
% $Id: sbo.tex 12123 2010-10-03 18:12:56Z mhucka $
% $HeadURL: https://svn.code.sourceforge.net/p/sbml/code/trunk/specifications/sbml-level-3/version-1/core/spec/sbo.tex $
% ----------------------------------------------------------------

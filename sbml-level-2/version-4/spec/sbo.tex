...
\begin{figure}[htb]
  ...
  \centering
  \includegraphics
  [scale = 0.7, bb=12 624 606 780]{figs/sbo-participant-type}
...
\begin{figure}[tbh]
  ...
  \centering
  \includegraphics
  [scale = 0.7, bb=63 390 576 575]{figs/sbo-quantitative-parameter}
...
\begin{figure}[tbh]
  ...
  \centering
  \includegraphics
  [scale = 0.7, bb=149 488 520 576]{figs/sbo-framework}
  \vspace*{-2ex}
  \caption{Partial expansion of some of the terms in the
...
\begin{figure}[tbh]
  \centering
  \includegraphics
  [scale = 0.7, bb=12 404 470 576]{figs/sbo-math-expression}
...
\begin{figure}[tbh]
  \centering
  \includegraphics
  [scale = 0.75, bb=40 414 592 575]{figs/sbo-event}

...
the \token{sboTerm} attribute value.  By adding SBO term
...
framework, (2) \changed{participant}, (3) quantitative parameter, (4)
...
for the \emph{\changed{participant}} CV which reflects the hierarchical
...
\begin{figure}[htb]
  ...
  \centering
  \includegraphics
  [scale = 0.7, viewport=12 624 606 780]{figs/sbo-participant-type}
  \caption{Partial expansion of some of the terms in the
    \emph{\changed{participant}} CV of SBO.}
...
\begin{figure}[tbh]
  ...
  \centering
  \includegraphics
  [scale = 0.7, viewport=63 390 576 575]{figs/sbo-quantitative-parameter}
...
\begin{figure}[tbh]
  ...
  \centering
  \includegraphics
  [scale = 0.7, viewport=149 488 520 576]{figs/sbo-framework}
  \vspace*{-2ex}
  \caption{Partial expansion of some of the terms in the
...
are likely to be included in the future in order to be
...
\begin{figure}[tbh]
  \centering
  \includegraphics
  [scale = 0.7, viewport=12 404 470 576]{figs/sbo-math-expression}
...
\begin{figure}[tbh]
  \centering
  \includegraphics
  [scale = 0.75, viewport=40 414 592 575]{figs/sbo-event}

...
involve events of some sort.  A single reaction event is one in
which some set of entities (known as ``reactants'', ``products'' and
...
reaction is a count of how many times the reaction has occurred,
while the time derivative of this extent gives the rate at which
the reaction is occurring.  Thus, what is colloquially referred to
as the ``rate of the reaction'' is in fact equal to the rate of
change of the extent.
...
corresponding attributes on the \Model object.  Let \stoichij

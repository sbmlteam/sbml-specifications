...
to) BioPAX (\url{https://www.biopax.org/}), PSI-MI
...
hierarchically-structured set of controlled vocabularies with seven
main divisions: (1) physical entity representation, (2) participant role, (3) systems description parameter, (4) modeling framework, (5)
mathematical expression, (6) occurring entity representation, and (7) metadata representation.  \fig{fig:sbo-top-level} illustrates
the highest level of SBO.

Each of the seven branches of \fig{fig:sbo-top-level} has a
...
consistent with future versions of SBO.  It reflects SBO as it existed in December, 2015.  The web site for SBO
...
\emph{physical entity representation} branch, which reflects the hierarchical groupings of
...
this branch, which is at this point fairly  simple, but we
...
\token{k} and \token{R}).  This makes it
...
The \emph{occurring entity representation} branch of SBO defines types of biological
...
\begin{figure}[htb]
  \centering
  \includegraphics[scale=0.8]{figs/sbo-annotation}
...
\begin{table}[ht]
  ...
  \begin{tabular}{lll}
    ...
    \Model              & occurring entity representation \emph{or} modeling framework			& \sbointeractionID \xspace\emph{or} \sboframeworkID\\
    \FunctionDefinition & mathematical expression   	& \sbomathformulaID \\
    \Compartment        & physical entity representation	& \sbophysicalentityID \\
    \Species            & physical entity representation	& \sbophysicalentityID \\
    \Reaction           & occurring entity representation     		& \sbointeractionID \\
    \Parameter          & systems description parameter    	& \sboparameterID \\
    ...
    \LocalParameter     & systems description parameter    	& \sboparameterID \\

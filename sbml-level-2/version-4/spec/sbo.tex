...
reaction, can help map SBML elements to \changed{equivalent concepts in
...
\begin{table}[bht]
  ...
  \begin{edtable}{tabular}{lll}
    \toprule
    \textbf{SBML Component} & \textbf{SBO Branch} & \textbf{\changed{Highest-Level SBO Identifier}} \\
    \midrule
    \Model              & \changed{interaction}     & \changed{\sboeventID} \\
    ...
    \Reaction           & \changed{interaction}     & \sboeventID \\
    \Parameter          & quantitative parameter    & \sboparameterID \\
    \SpeciesReference   & \changed{participant role}          & \sboparticipantfunctionalID \\
    \ModifierSpeciesReference & \changed{participant role}    & \sboparticipantfunctionalID \\
    ...
    \Event              & \changed{interaction}     & \sboeventID \\

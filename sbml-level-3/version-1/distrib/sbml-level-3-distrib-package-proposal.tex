...
\emph{Note!  \notice These examples are all from a previous version of the specification and have NOT BEEN UPDATED to reflect the latest version.  It should still be possible to translate all of these examples to the new scheme; it just hasn't been done yet.  This will happen before the official release of this version of the specification.}

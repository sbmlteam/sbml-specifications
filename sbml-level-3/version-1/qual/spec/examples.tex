...
\bigskip
\subsection{Logical model of the immunity control in bacteriophage lambda \cite{thieffry95}}
\label{sub:ex_phage}
This last example is the multi-valued, logical model as defined in \cite{thieffry95} for the core network controlling the decision between lysis and lysogenization in temperate bacteriophage. 

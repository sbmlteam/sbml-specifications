...
\Compartment of \token{size} 3 is measured within the model. The
...
\Compartment of \token{size} 2 is measured within the model. The
value must be of type \primtype{UnitSIdRef}
(Section:~\vref{sec:unitsidref}). This value can be changed for
individual compartments (Section:~\vref{sec:compartments}). A
list of recommended units is given in
...
\Compartment of \token{size} 1 is measured within the model. The
value must be of type \primtype{UnitSIdRef}
(Section:~\vref{sec:unitsidref}). This value can be changed for
individual compartments (Section:~\vref{sec:compartments}). A
list of recommended units is given in
...
This attribute specifies the units in which the extend of
{\Reaction}s is measured within the model. The value must be of
type \primtype{UnitSIdRef} (Section:~\vref{sec:unitsidref}). A
list of recommended units is given in 
section~\vref{sec:bp:unitdefinitions:recommendedunits:extendUnits}. 
...
\token{size} value \emph{does not imply that the compartment size
  is 1}.  There is no default value of compartment size.  A 
missing value for \token{size} for a given

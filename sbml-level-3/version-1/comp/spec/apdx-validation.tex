...
\validRule{comp-10101}{In order to conform to the Hierarchical Model
  ...
  (References: SBML L3 Hierarchical Composition Package V2,
...
\validRule{comp-10302}{The values of the attributes \token{id} and
  ...
  Hierarchical Composition Package V2 Section~\ref{namespaces}.)}
...
\validRule{comp-10303}{Within a \Model or \ExternalModelDefinition
  ...
  Package V2 Section~\ref{namespaces}.) }
...
\validRule{comp-10308}{The value of a \token{comp:\-submodel\-Ref} attribute
  ...
  Composition Package V2 Section~\ref{replacedelement-submodelref}.) }
...
\validRule{comp-10309}{The value of a \token{comp:\-deletion} attribute on
  ...
  SBML data type \primtype{SId}.  (References: SBML L3 Hierarchical
  Composition Package V2 Section~\ref{replacedelement-deletion}.) }

\validRule{comp-10310}{The value of a \token{comp:\-con\-version\-Factor}
  ...
  Hierarchical Composition Package V2
...
\validRule{comp-20103}{A \ListOfReplacedElements object may have the
  optional attributes \token{meta\-id} and \token{sboTerm} defined by SBML
...
\validRule{comp-20104}{The \ListOfReplacedElements in an \SBase object
  is optional, but if present, must not be emp\-ty.  (References: SBML L3
  Hierarchical Composition Package V2
  Section~\ref{extended-sbase-class}.) }
...
\validRule{comp-20203}{The value of
  ...
  \Submodel with \Species, \Parameter, \Compartment, \Reaction, or \Event objects that
  have not been either directly or indirectly replaced.  (References: SBML
  L3 Hierarchical Composition Package V2 Section~\ref{xml-namespace}.) }

\validRule{comp-20204}{The value of
  attribute \token{comp:\-required} on the \SBML object must be set to
  \val{false} if the \Model object within the \SBML object contains no
  \Submodel objects, or if all \Submodel objects that are present contain
  no \Species, \Parameter, \Compartment, \Reaction, or \Event objects that
  have not been either directly or indirectly replaced.  (References: SBML
  L3 Hierarchical Composition Package V2 Section~\ref{xml-namespace}.) }

\validRule{comp-20205}{There may be at most one instance of each of the
  ...
  Composition Package V2 Section~\ref{sbml-class}.) }
...
\validRule{comp-20209}{A \ListOfModelDefinitions object may have the
  ...
  object.  (References: SBML L3 Hierarchical Composition Package V2
  Section~\ref{listofmodeldefinitions-class}.) }

\validRule{comp-20210}{A \ListOfExternalModelDefinitions object may have
  the optional SBML core attributes \token{meta\-id} and \token{sboTerm}.
...
\validRule{comp-20303}{An ExternalModelDefinition object must have the
  ...
  have the optional attributes \token{comp:\-model\-Ref} and
...
\validRule{comp-20304}{The value of the \token{comp:\-\-source} attribute on
  ...
  document.  (References: SBML L3 Hierarchical Composition Package V2
  Section~\ref{externalmodeldefinition-class}.) }

\validRule{comp-20305}{The value of the \token{comp:\-model\-Ref} attribute
...
\consistencyRule{comp-20306}{The value of the \token{comp:\-md5} attribute
  ...
  attribute.  (References: SBML L3 Hierarchical Composition Package V2
  Section~\ref{externalmodeldefinition-class}.) }
...
\validRule{comp-20307}{The value of a \token{comp:\-\-source} attribute on
  ...
  L3 Hierarchical Composition Package V2
  Section~\ref{externalmodeldefinition-class}.) }

\validRule{comp-20308}{The value of a \token{comp:\-model\-Ref} attribute on
  an \ExternalModelDefinition object must always conform to the syntax
...
\validRule{comp-20309}{The value of a \token{comp:\-md5} attribute on an
  ...
  Package V2 Section~\ref{externalmodeldefinition-class}.) }

\validRule{comp-20310}{An 
  ...
  objects.  (References: SBML L3 Hierarchical Composition Package V2
  Section~\ref{externalmodeldefinition-class}.) }
...
\validRule{comp-20501}{There may be at most one instance of each of the
  ...
  SBML L3 Hierarchical Composition Package V2
...
\validRule{comp-20503}{Apart from the general notes and annotation
  ...
  Hierarchical Composition Package V2 Section~\ref{model-class}.) }
...
\validRule{comp-20505}{A \ListOfSubmodels object may have the optional
  ...
  Composition Package V2 Section~\ref{model-class}.) }
...
\validRule{comp-20607}{A \Submodel object must have the required
  attributes \token{comp:\-id} and \token{comp:\-model\-Ref}, and may also
  have any or all of the optional attributes 
...
\validRule{comp-20608}{The value of a \token{comp:\-model\-Ref} attribute on
  ...
  Package V2 Section~\ref{submodel-modelref}.) }
...
\validRule{comp-20612}{The value of a
  ...
  V2 Section~\ref{submodel-conversion}.) }
...
\validRule{comp-20613}{The value of a \token{comp:\-timeConversionFactor}
  ...
  Composition Package V2 Section~\ref{submodel-conversion}.) }
...
\validRule{comp-20615}{The value of a \token{comp:\-model\-Ref} attribute on
  a \Submodel must be the identifier of a \Model or
  \ExternalModelDefinition object in the same \SBML object as the
  \Submodel.  (References: SBML L3 Hierarchical Composition Package V2
...
\validRule{comp-20616}{A \Model object must not contain a \Submodel
  ...
  \token{comp:\-model\-Ref} attribute on a \Submodel must not be the value
  of the parent \Model object's \token{id} attribute.  (References: SBML L3
  Hierarchical Composition Package V2 Section~\ref{submodel-modelref}.)}

\validRule{comp-20617}{A \Model object must not contain a \Submodel
  which references that \Model indirectly.  That is, the
  \token{comp:\-model\-Ref} attribute of a \Submodel may not point to the
...
\validRule{comp-20701}{The value of a \token{comp:\-port\-Ref} attribute on
  an \SBaseRef object must be the identifier of a \Port object in the
  \Model referenced by that \SBaseRef.  (References: SBML L3
  Hierarchical Composition Package V2 Section~\ref{sbaseref-portref}.) }

\validRule{comp-20702}{The value of a \token{comp:\-id\-Ref} attribute on an
  ...
  Hierarchical Composition Package V2 Section~\ref{sbaseref-idref}.)  }

\validRule{comp-20703}{The value of a \token{comp:\-unit\-Ref} attribute on
...
\validRule{comp-20704}{The value of a \token{comp:\-metaId\-Ref} attribute
  ...
  \SBaseRef.  This includes elements with \token{meta\-id} attributes
  ...
  Composition Package V2 Section~\ref{sbaseref-metaidref}.)}
...
\validRule{comp-20706}{The value of a \token{comp:\-port\-Ref} attribute on
  an \SBaseRef object must always conform to the syntax of the SBML data
  type \primtype{SId}.  (References: SBML L3 Hierarchical Composition
  Package V2 Section~\ref{sbaseref-portref}.) }

\validRule{comp-20707}{The value of a \token{comp:\-id\-Ref} attribute on an
  \SBaseRef object must always conform to the syntax of the SBML data
  type \primtype{SId}.  (References: SBML L3 Hierarchical Composition
  Package V2 Section~\ref{sbaseref-idref}.) }

\validRule{comp-20708}{The value of a \token{comp:\-unit\-Ref} attribute on
  an \SBaseRef object must always conform to the syntax of the SBML data
  type \primtype{UnitSId}.  (References: SBML L3 Hierarchical
  Composition Package V2 Section~\ref{sbaseref-unitref}.) }

\validRule{comp-20709}{The value of a \token{comp:\-metaId\-Ref} attribute
...
\validRule{comp-20801}{A \Port object must point to another object; that
  ...
  \token{comp:\-id\-Ref}, \token{comp:\-unit\-Ref}, or \token{comp:\-metaId\-Ref}.
  (References: SBML L3 Hierarchical Composition Package V2
...
\validRule{comp-20802}{A \Port object can only point to \emph{one} other
  ...
  \token{comp:\-metaId\-Ref}.  (References: SBML L3 Hierarchical Composition
  Package V2 Section~\ref{port-class}.) }

\validRule{comp-20803}{A \Port object must have a value for the required
  attribute \token{comp:\-id}, and one, and only one, of the attri\-butes
  \token{comp:\-id\-Ref}, \token{comp:\-unit\-Ref}, or \token{comp:\-metaId\-Ref}.
  ...
  Composition Package V2 Section~\ref{port-class}.) }
...
\validRule{comp-20804}{Port definitions must be unique; that is, no two
  ...
  \Model.  (References: SBML L3 Hierarchical Composition Package V2
  Section~\ref{port-class}.) }
...
\validRule{comp-20901}{A \Deletion object must point to another object;
  ...
  \token{comp:\-unit\-Ref}, or \token{comp:\-metaId\-Ref}.  (References: SBML L3
  Hierarchical Composition Package V2 Section~\ref{deletion-class}.) }
...
\validRule{comp-20902}{A \Deletion object can only point to \emph{one}
  ...
  for one of the attributes \token{comp:\-port\-Ref}, \token{comp:\-id\-Ref},
  \token{comp:\-unit\-Ref}, or \token{comp:\-metaId\-Ref}.  (References: SBML L3
  Hierarchical Composition Package V2 Section~\ref{deletion-class}.) }
...
\validRule{comp-20903}{A \Deletion object must have a value for the
  ...
  attributes \token{comp:\-port\-Ref}, \token{comp:\-id\-Ref},
  \token{comp:\-unit\-Ref}, or \token{comp:\-metaId\-Ref}.  No other attributes
  ...
  Package V2 Section~\ref{deletion-class}.) }
...
\validRule{comp-21001}{A \ReplacedElement object must point to another
  ...
  \token{comp:\-id\-Ref}, \token{comp:\-unit\-Ref}, \token{comp:\-metaId\-Ref}, or
  \token{comp:\-deletion}.  (References: SBML L3 Hierarchical Composition
  Package V2 Section~\ref{replacedelement-class}.) }
...
\validRule{comp-21002}{A \ReplacedElement object can only point to
  ...
  have a value for one of the following attributes: \token{comp:\-port\-Ref},
  \token{comp:\-id\-Ref}, \token{comp:\-unit\-Ref}, \token{comp:\-metaId\-Ref}, or
  \token{comp:\-deletion}.  (References: SBML L3 Hierarchical Composition
  Package V2 Section~\ref{replacedelement-class}.) }
...
\validRule{comp-21003}{A \ReplacedElement object must have a value for
  ...
  attribute \token{comp:\-con\-version\-Factor}.  No other attributes from the
  Hierarchical Model Composition namespace are permitted on a
  \ReplacedElement object.  (References: SBML L3 Hierarchical
  Composition Package V2 Section~\ref{replacedelement-class}.) }

\validRule{comp-21004}{The value of a \token{comp:\-submodel\-Ref} attribute
...
\validRule{comp-21006}{The value of a \token{con\-version\-Factor} attribute
  on a \ReplacedElement object must be the identifier of a \Parameter
  present in the \ReplacedElement object's parent \Model.  (References:
  SBML L3 Hierarchical Composition Package V2
  Section~\ref{replacedelement-conversionfactor}.) }

\validRule{comp-21007}{The value of a \token{comp:\-submodel\-Ref} attribute
  on a \ReplacedElement object must always conform to the syntax of the
  SBML data type \primtype{SId}.  (References: SBML L3 Hierarchical
  Composition Package V2 Section~\ref{replacedelement-submodelref}.) }
...
\validRule{comp-21009}{The value of a \token{comp:\-con\-version\-Factor}
  attribute on a \ReplacedElement object must always conform to the
  syntax of the SBML data type \primtype{SId}.  (References: SBML L3
  Hierarchical Composition Package V2
  Section~\ref{replacedelement-conversionfactor}.) }

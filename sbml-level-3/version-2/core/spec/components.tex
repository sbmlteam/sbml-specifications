...
\sec{sec:before-t0} provides additional information about
the semantics of assignments, rules and values for simulation time
$t \leq 0$.  \relchange{Real world examples of variable stoichiometry in models include genome-scale models \citep{obrien:2013}, and can generally be found in searches such as \url{https://scholar.google.com/scholar?q=model+variable+stoichiometry}.}

...
Core~\citep{DCMI:2003} and BioModels.net qualifier elements \changed{(see
...
this might correspond to the URI \changed{\uri{http://identifiers.org/uniprot/P12999}} \citep{juty:2012}.
...
\begin{table}[b]
  ...
  \begin{edtable}{tabular}{lp{4.84in}}
    ...
    \midrule
    \changed{\token{bqmodel:hasInstance}}
    & \changed{The subject of the referenced resource is 
    ...
    \\[6pt]
    \changed{\token{bqmodel:isInstanceOf}}
    & \changed{The modeling object represented by the model element is an
    ...
    & \changed{The biological entity represented by the SBML component is

...
example, if the SBO identifier \token{SBO:0000049} is assigned to
...
has an \token{sboTerm} attribute with this value, then regardless
...
\begin{figure}[tbh]
  \centering
  \includegraphics[scale = 0.87]{figs/sbo-quantitative-parameter}
  \caption{Partial expansion of some of the terms in the
...
\begin{figure}[tbh]
  \centering
  \vspace*{1ex}
  \includegraphics[scale = 0.85]{figs/sbo-framework}
  \caption{Partial expansion of some of the terms in the
...
\item \emph{Parent(s)}: 
  ...
  \item \token{SBO:0000163} irreversible mass action rate law,

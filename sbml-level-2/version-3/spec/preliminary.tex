...
\item The \SBase abstract type is used as the base type for
  certain \changed{objects} such as \Sbml, \Unit, \AssignmentRule, etc.,
  which do not have identifiers because these components do not
  need to be referenced by other components.  If \SBase had a

...
0.3 (Draft) & 16 Oct 2011 & Stuart Moodie & Filled empty invocation semantics section.\\ \bottomrule
\end{edtable}
...
class \class{Distribution} that is part of the distrib package
extension to SBML Level 3 Core. The \class{Distribution} class can
...
\class{Distribution} can contain a \mlambda class that defines the
...
The \class{Distribution} class contains either one instance of
...
This attribute is a \primtype{boolean} and is mandatory. If its value is \value{true}
...
This attribute is of type \primtype{boolean} and is mandatory. It
...
This value is of type \primtype{double} and is not mandatory. It
...
the retrieval of a scalar result of type \primtype{double}. Not that
...
\Distribution with \token{truncated}=\value{true}, it is necessary to
...
The authors would like to thank %in particular Nicolas Le Nov\`{e}re,

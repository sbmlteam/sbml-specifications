...
\begin{table}[bh]
  ...
  \begin{edtable}{tabular}{lll}
    ...
    \verone{\token{vcard}   & \uri{http://www.w3.org/2001/vcard-rdf/3.0\#} & \cite{iannella:2001} \\[1pt]}
    \token{vcard4}  & \uri{http://www.w3.org/2006/vcard/ns\#} & \cite{perreault:2011} \\[1pt]
    \token{bqbiol}  & \uri{http://biomodels.net/biology-qualifiers/} & \url{https://co.mbine.org/standards/qualifiers} \\[1pt]
    \token{bqmodel} & \uri{http://biomodels.net/model-qualifiers/} & \url{https://co.mbine.org/standards/qualifiers} \\[1pt]
    \bottomrule
  \end{edtable}
  \vspace*{-0.95ex}
...
resource might be \uri{https://www.uniprot.org/uniprot/P12999}, and
this might correspond to the URI \uri{https://identifiers.org/uniprot/P12999} \citep{juty:2012}.
...
identifier \uri{https://identifiers.org/uniprot/P12999}, thereby identifying
...
\uri{https://identifiers.org/go/GO:0007268} can be translated into any
of the following:
\begin{itemize}\setlength{\parskip}{-1ex}

\item \uri{http://amigo.geneontology.org/amigo/term/GO:0007268}
\item \uri{https://www.ebi.ac.uk/QuickGO/GTerm?id=GO:0007268}
\item \uri{http://www.informatics.jax.org/vocab/gene\_ontology/GO:0007268}

\end{itemize}
\vspace*{-1ex}

Similarly, \uri{https://identifiers.org/ec-code/3.5.4.4} can refer to
any of the following (among many):
\begin{itemize}\setlength{\parskip}{-1ex}

\item \uri{https://www.ebi.ac.uk/intenz/query?cmd=SearchEC\&ec=3.5.4.4}
\item \uri{https://www.metanetx.org/cgi-bin/mnxweb/search?query=3.5.4.4}
\item \uri{https://enzyme.expasy.org/EC/3.5.4.4}
...
of the format contained in the light gray box (\token{vCard4:fn} or \token{vCard4:hasName}, plus \token{vCard4:hasEmail}, and \token{vCard4:organization-name}) can occur in any
order.  The elements of the format contained between \texttt{[}
and \texttt{]} (\token{vCard4:organization-name}, and \token{vCard4:hasEmail}) are optional, but everything else is required.  The precise form of the whitespace,
and the specific XML namespace prefixes used (\val{dcterms}, \val{rdf}, and \val{vcard4}) are not constrained.

The \token{dcterms:creator} element describes the person(s) who created
...
those elements can be the following: \verone{\token{vcard:N},
\token{vcard:EMAIL} and \token{vcard:ORG} (if using \token{vCard} version 3), or} \token{vCard4:fn} or \token{vCard4:hasName}, plus \token{vCard4:hasEmail}, and \token{vCard4:organization-name}\verone{ (if using \token{vCard} version 4)}.
The \token{dcterms:created}, and \token{dcterms:modified} elements
must have the attribute \token{rdf:parseType} set to the literal
value \val{Resource}.

Note that \token{dcterms:creator} has been added to \token{http://purl.org/dc/terms/} relatively recently, but the same term (with the same meaning) exists in the \token{http://purl.org/dc/elements/1.1/} namespace.  It is legal to continue using the old namespace (called \val{dc} in previous versions of the SBML specifications), but since all the terms defined there are now also defined in \token{http://purl.org/dc/terms/}, we recommend using the latter.
...
a person who created the model; when using \token{vCard4}, \fullName stands for the full name of that person.  \emailAddress is the email address
  ...
  <annotation>
    ...
    >
      <rdf:Description rdf:about="#_180340">
        ...
        <bqmodel:is>
          <rdf:Bag>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/biomodels.db/BIOMD0000000003\!"/>
          </rdf:Bag>
        </bqmodel:is>
        <bqmodel:isDescribedBy>
           <rdf:Bag>
             <rdf:li rdf:resource="\changed{https:}//identifiers.org/pubmed/1833774\!"/>
           </rdf:Bag>
        </bqmodel:isDescribedBy>
        <bqbiol:isVersionOf>
          <rdf:Bag>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/wikipathways/WP179\!"/>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/reactome/REACT_152\!"/>
          </rdf:Bag>
        </bqbiol:isVersionOf>
      </rdf:Description>
    </rdf:RDF>
...
\begin{example}
<reaction id="cdc2Phospho" metaid="jb007" reversible="true"\verone{ fast="false"}>
  <annotation>
    <rdf:RDF
      xmlns:bqbiol="http://biomodels.net/biology-qualifiers/"
      xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns\#"
    >
      <rdf:Description rdf:about="#jb007">
        <bqbiol:is>
          <rdf:Bag>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/reactome/REACT_6327\!"/>
          </rdf:Bag>
        </bqbiol:is>
      </rdf:Description>
    </rdf:RDF>
  ...
  <annotation>
    ...
    >
      <rdf:Description rdf:about="\#cacam">
        <bqbiol:hasPart>
          <rdf:Bag>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/uniprot/P62158\!"/>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/chebi/CHEBI:29108\!"/>
          </rdf:Bag>
        </bqbiol:hasPart>
      </rdf:Description>
    </rdf:RDF>
  ...
  <annotation>
    ...
    >
      <rdf:Description rdf:about="\#cacam">
        <bqbiol:hasVersion>
          <rdf:Bag>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/uniprot/Q9UQM7\!"/>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/uniprot/Q13554\!"/>
          </rdf:Bag>
        </bqbiol:hasVersion>
      </rdf:Description>
    </rdf:RDF>
...
<reaction id="NMDAR_phosphorylation" metaid="thx1138"
          reversible="true"\verone{ fast="false"}>
  <annotation>
    <rdf:RDF
      xmlns:bqbiol="http://biomodels.net/biology-qualifiers/"
      xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns\#"
    >
      <rdf:Description rdf:about="#thx1138">
        <bqbiol:isVersionOf>
          <rdf:Bag>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/ec-code/2.7.1.17\!"/>
          </rdf:Bag>
        </bqbiol:isVersionOf>
      </rdf:Description>
    </rdf:RDF>
  ...
  <annotation>
    ...
    >
      <rdf:Description rdf:about="\#C8H10N4O2">
        <bqbiol:isVersionOf>
          <rdf:Bag>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/go/GO:0005954\!"/>
          </rdf:Bag>
        </bqbiol:isVersionOf>
      </rdf:Description>
    </rdf:RDF>
  ...
  <annotation>
    ...
    >
      <rdf:Description rdf:about="\#GXP">
        <bqbiol:hasVersion>
          <rdf:Bag>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/chebi/CHEBI:17345\!"/>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/chebi/CHEBI:17552\!"/>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/chebi/CHEBI:17627\!"/>
          </rdf:Bag>
        </bqbiol:hasVersion>
        <bqbiol:hasVersion>
          <rdf:Bag>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/kegg.compound/C00035\!"/>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/kegg.compound/C00044\!"/>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/kegg.compound/C00144\!"/>
          </rdf:Bag>
        </bqbiol:hasVersion>
      </rdf:Description>
    </rdf:RDF>
...
\begin{example}
<reaction id="adenineProd" metaid="adeprod" reversible="true"\verone{ fast="false"}>
  <annotation>
    <rdf:RDF
      xmlns:bqbiol="http://biomodels.net/biology-qualifiers/"
      xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns\#"
    >
      <rdf:Description rdf:about="\#adeprod">
        <bqbiol:hasPart>
          <rdf:Bag>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/ec-code/2.5.1.22\!"/>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/ec-code/3.2.2.16\!"/>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/ec-code/4.1.1.50\!"/>
          </rdf:Bag>
        </bqbiol:hasPart>
        <bqbiol:hasPart>
          <rdf:Bag>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/kegg.reaction/R00178\!"/>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/kegg.reaction/R01401\!"/>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/kegg.reaction/R02869\!"/>
          </rdf:Bag>
        </bqbiol:hasPart>
      </rdf:Description>
    </rdf:RDF>
  ...
  <annotation>
    ...
    >
     <rdf:Description rdf:about="\#heme">
       <bqbiol:hasPart>
         <rdf:Bag>
           <rdf:li rdf:resource="\changed{https:}//identifiers.org/uniprot/P69905\!"/>
           <rdf:li rdf:resource="\changed{https:}//identifiers.org/uniprot/P68871\!"/>
           <rdf:li rdf:resource="\changed{https:}//identifiers.org/chebi/CHEBI:17627\!"/>
         </rdf:Bag>
       </bqbiol:hasPart>
       <bqbiol:hasPart>
         <rdf:Bag>
           <rdf:li rdf:resource="\changed{https:}//identifiers.org/uniprot/P69905\!"/>
           <rdf:li rdf:resource="\changed{https:}//identifiers.org/uniprot/P68871\!"/>
           <rdf:li rdf:resource="\changed{https:}//identifiers.org/kegg.compound/C00032\!"/>
         </rdf:Bag>
       </bqbiol:hasPart>
     </rdf:Description>
   </rdf:RDF>
  ...
  <annotation>
    ...
    >
      <rdf:Description rdf:about="\#phosphorylation">
        <bqbiol:is>
          <rdf:Bag>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/kegg.reaction/R03313\!"/>
          </rdf:Bag>
        </bqbiol:is>
        <bqbiol:isVersionOf>
          <rdf:Bag>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/go/GO:0016310\!"/>
          </rdf:Bag>
        </bqbiol:isVersionOf>
      </rdf:Description>
    </rdf:RDF>
  ...
  <annotation>
    <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
      ...
      <rdf:Description rdf:about="#_000004">
        <bqbiol:occursIn>
          <rdf:Bag>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/go/GO:0005764"/>
            <bqbiol:isDescribedBy>
              <rdf:Bag>
                <rdf:li rdf:resource="\changed{https:}//identifiers.org/pubmed/1111111"/>
              </rdf:Bag>
            </bqbiol:isDescribedBy>
            <bqbiol:isDescribedBy>
              <rdf:Bag>
                <rdf:li rdf:resource="\changed{https:}//identifiers.org/eco/ECO:0000004"/>
              </rdf:Bag>
            </bqbiol:isDescribedBy>
          </rdf:Bag>
        </bqbiol:occursIn>
  ...
  <annotation>
    <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
      ...
      <rdf:Description rdf:about="#_000004" >
        <bqbiol:isVersionOf>
          <rdf:Bag>
            <rdf:li rdf:resource="\changed{https:}//identifiers.org/uniprot/P04551"/>
            <bqbiol:isVersionOf>
              <rdf:Bag>
                <rdf:li rdf:resource="\changed{https:}//identifiers.org/psimod/MOD:00047"/>
              </rdf:Bag>
            </bqbiol:isVersionOf>
          </rdf:Bag>
        </bqbiol:isVersionOf>

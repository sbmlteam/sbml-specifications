...
A low-volume, broadcast-only web forum/mailing list is available
...
advertising and its membership will never be disclosed.  \emph{It
  is vitally important that all users of SBML stay informed about new
  releases and other developments by subscribing to
  \link{http://sbml.org/Forums/sbml-announce}{sbml-announce}}, even
if they do not wish to participate in discussions on
  \link{http://sbml.org/Forums/sbml-discuss}{sbml-discuss}.  Please visit
\link{http://sbml.org/Forums/sbml-announce}{sbml.org/forums/sbml-announce}
for information about how to subscribe to the list as well as for

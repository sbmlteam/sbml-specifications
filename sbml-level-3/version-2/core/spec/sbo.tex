...
consistent with future versions of SBO.  \changed{It reflects SBO as it existed in December, 2015.}  The web site for SBO
...
\begin{table}[ht]
  ...
  \begin{tabular}{lll}
    ...
    \Model              & \changed{occurring entity representation \emph{or} modeling framework}			& \sbointeractionID \changed{\emph{or} \sboframeworkID}\\

...
\item \uri{http://www.sbml.org/sbml/symbols/avogadro}.  This
  represents the constant Avogadro's number.  \mathmltwo defines
  several constants, such as \token{pi}, but none for Avogadro's
  number.  Without this it is necessary to include the number
  literally, thus making it difficult for software to identify 

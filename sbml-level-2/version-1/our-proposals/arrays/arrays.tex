...
of a seperate package (called \texttt{optimization})?
\end{itemize}
...
This model doesn't contain any reactions.  We're assuming that SBML Level 2 will
allow models to contain no reactions.

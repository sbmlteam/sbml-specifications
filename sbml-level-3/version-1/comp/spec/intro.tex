...
has a long history, which we summarize in \sect{background}.  It has
...
Processes features.  (If you find incompatibilities with other packages,
please contact the Package Working Group.  Contact information is shown on the front

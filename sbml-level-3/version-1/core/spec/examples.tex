...
of \emph{millimoles}, but \val{P} is given in \emph{grams}.  
...
as they appear in the \KineticLaw elements are now in units of \emph{millimole}/\emph{litre}.
...
\begin{linenomath}
  \begin{equation*}
      c_{\text{e}} = c_{\text{s}} = c_{\text{es}} = 10^{-3}\;\emph{mole} \;\emph{millimole}^{\,-1}
  \end{equation*}
\end{linenomath}

...
\newtxt{The \FBCPackage defines a new enumerated type \primtype{FbcType} that indicates whether the objective function should be maximized or minimized and can have either of two values \val{maximize} or \val{minimize}.}

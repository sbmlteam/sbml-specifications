...
\token{\rule{0.2in}{0.5pt}ConversionFactor} attributes apply.

%LS NOTE:  I cannot for the life of me figure out how subelements
% used as targets of ReplacedBy elements work in this scheme. Should
% they be affected by the automatic conversion factors?  Only by their
% conversionFactor?  Should they even *have* a conversionFactor attribute?
% I'm totally confused, and will have to actually implement this before
% I manage to figure out what's going on.

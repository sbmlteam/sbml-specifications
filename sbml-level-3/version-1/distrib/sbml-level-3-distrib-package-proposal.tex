...
\begin{figure}[htb]
\includegraphics[width=0.55\linewidth]{figs/uncertValue.pdf}
...
%In a version of this model that used Arrays package constructs, a single vector could be created with all three values in it, and given an \Uncertainty child with \token{value} elements that contained vectors instead of single values.

...
% $Id: front-page.tex 12142 2010-10-06 05:07:14Z mhucka $
% $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/trunk/specifications/sbml-level-3/version-1/core/spec/front-page.tex $
% ----------------------------------------------------------------
...
\date{\vfill \textbf{SBML \thisLV} \\[10pt]%
  \changed{\textbf{Release \sbmlrelease}} \\[10pt]%
  \sbmldate\\[10pt]%
(Journal of Integrative Bioinformatics edition, August 2015)
}

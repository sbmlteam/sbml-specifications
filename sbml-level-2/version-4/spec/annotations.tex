...
This format should \emph{not} be used to refer to SBO terms, that should be refered to using the attribute \token{sboTerm} part of \token{SBase}
(Section~\ref{sec:sboTerm}). However one may nevertheless want to do so, for instance to be able to add further information about functional role of a species.

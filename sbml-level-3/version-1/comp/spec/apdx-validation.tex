...
\consistencyRule{comp-21205}{If one element replaces another, whether it is the target of a \ReplacedBy element, or whether it has a child \ReplacedElement, the units of the replaced element, multiplied by the units of any applicable conversion factor, should equal the units of the replacement element.
  (References: SBML Level~3 Package Specification for Hierarchical Model
  Composition, Version~1, \sec{replacedelement-additional}.) }
\end{blockChanged}

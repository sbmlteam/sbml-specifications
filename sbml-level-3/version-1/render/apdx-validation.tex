...
\validRule{render-20202}{The value of the attribute
\token{render:\-objectRole} of a \GraphicalObject object must be TO DO. (Reference: SBML Level~3 Specification for Render
...
\validRule{render-20603}{An \RenderEllipse object must contain one and
...
one instance of the \ListOfGradientStops element. No other elements from the
...
\validRule{render-20906}{The \ListOfGradientStops subobject on a \GradientBase
...
subobjects permitted on all SBML objects, a \ListOfGradientStops container
...
\validRule{render-20908}{A \ListOfGradientStops object may have the optional
SBML Level~3 Core attributes \token{metaid} and \token{sboTerm}. No
other attributes from the SBML Level 3 Core namespaces are permitted on
a \ListOfGradientStops object. (Reference: SBML Level~3 Specification for Render
Version~1, \sec{gradientbase-class}.)}
...
\validRule{render-21004}{A \GradientStop object must contain one and
...
\validRule{render-21112}{The \ListOfElements subobject on a \RenderGroup
object is optional, but if present, this container object must not be
empty. (Reference: SBML Level~3 Specification for Render Version~1,
\sec{rendergroup-class}.)}

\validRule{render-21113}{Apart from the general notes and annotations
...
\validRule{render-21114}{A \ListOfElements object may have the optional
SBML Level~3 Core attributes \token{metaid} and \token{sboTerm}. No
other attributes from the SBML Level 3 Core namespaces are permitted on
...
\validRule{render-21204}{An \Image object must contain one and only one
...
\validRule{render-21205}{The attribute \token{render:\-href} on an
...
\validRule{render-21403}{A \LinearGradient object may contain one and
...
\validRule{render-21703}{A \Polygon object must contain one and only one
...
\validRule{render-21704}{Apart from the general notes and annotations
subobjects permitted on all SBML objects, a \ListOfElements container
object may only contain \RenderPoint objects. (Reference: SBML Level~3
Specification for Render Version~1, \sec{polygon-class}.)}

\validRule{render-21705}{A \ListOfElements object may have the optional
SBML Level~3 Core attributes \token{metaid} and \token{sboTerm}. No
other attributes from the SBML Level 3 Core namespaces are permitted on
a \ListOfElements object. (Reference: SBML Level~3 Specification for
...
\validRule{render-21803}{A \RadialGradient object may contain one and
only one instance of each of the RelAbsVector, RelAbsVector,
...
\validRule{render-21903}{A \RenderRectangle object must contain one and
only one instance of each of the RelAbsVector, RelAbsVector and
\RelAbsVector elements, and may contain one and only one instance of
...
\validRule{render-22001}{A \RelAbsVector object may have the optional
SBML Level~3 Core attributes \token{metaid} and \token{sboTerm}. No
other attributes from the SBML Level 3 Core namespaces are permitted on
a \RelAbsVector. (Reference: SBML Level~3 Version~1 Core, Section~3.2.)}

\validRule{render-22002}{A \RelAbsVector object may have the optional
SBML Level~3 Core subobjects for notes and annotations. No other
elements from the SBML Level 3 Core namespaces are permitted on a
\RelAbsVector. (Reference: SBML Level~3 Version~1 Core, Section~3.2.)}

\validRule{render-22003}{A \RelAbsVector object may have the optional
...
\validRule{render-22004}{The attribute \token{render:\-abs} on a
\RelAbsVector must have a value of data type \token{double}. (Reference:
SBML Level~3 Specification for Render Version~1,
\sec{relabsvector-class}.)}

\validRule{render-22005}{The attribute \token{render:\-rel} on a
\RelAbsVector must have a value of data type \token{double}. (Reference:
SBML Level~3 Specification for Render Version~1,
\sec{relabsvector-class}.)}
...
\validRule{render-22101}{A \RenderCubicBezier object may have the
optional SBML Level~3 Core attributes \token{metaid} and
\token{sboTerm}. No other attributes from the SBML Level 3 Core
namespaces are permitted on a \RenderCubicBezier. (Reference: SBML
Level~3 Version~1 Core, Section~3.2.)}

\validRule{render-22102}{A \RenderCubicBezier object may have the
optional SBML Level~3 Core subobjects for notes and annotations. No
other elements from the SBML Level 3 Core namespaces are permitted on a
\RenderCubicBezier. (Reference: SBML Level~3 Version~1 Core,
Section~3.2.)}

\validRule{render-22103}{A \RenderCubicBezier object must contain one
...
\validRule{render-22201}{A \RenderCurve object may have the optional
SBML Level~3 Core attributes \token{metaid} and \token{sboTerm}. No
other attributes from the SBML Level 3 Core namespaces are permitted on
a \RenderCurve. (Reference: SBML Level~3 Version~1 Core, Section~3.2.)}

\validRule{render-22202}{A \RenderCurve object may have the optional
SBML Level~3 Core subobjects for notes and annotations. No other
elements from the SBML Level 3 Core namespaces are permitted on a
\RenderCurve. (Reference: SBML Level~3 Version~1 Core, Section~3.2.)}

\validRule{render-22203}{A \RenderCurve object may have the optional
...
\validRule{render-22204}{A \RenderCurve object must contain one and only
...
\validRule{render-22207}{Apart from the general notes and annotations
subobjects permitted on all SBML objects, a \ListOfElements container
object may only contain \RenderPoint objects. (Reference: SBML Level~3
Specification for Render Version~1, \sec{rendercurve-class}.)}

\validRule{render-22208}{A \ListOfElements object may have the optional
SBML Level~3 Core attributes \token{metaid} and \token{sboTerm}. No
other attributes from the SBML Level 3 Core namespaces are permitted on
a \ListOfElements object. (Reference: SBML Level~3 Specification for
Render Version~1, \sec{rendercurve-class}.)}
...
\validRule{render-22301}{A \RenderPoint object may have the optional
SBML Level~3 Core attributes \token{metaid} and \token{sboTerm}. No
other attributes from the SBML Level 3 Core namespaces are permitted on
a \RenderPoint. (Reference: SBML Level~3 Version~1 Core, Section~3.2.)}

\validRule{render-22302}{A \RenderPoint object may have the optional
SBML Level~3 Core subobjects for notes and annotations. No other
elements from the SBML Level 3 Core namespaces are permitted on a
\RenderPoint. (Reference: SBML Level~3 Version~1 Core, Section~3.2.)}

\validRule{render-22303}{A \RenderPoint object must contain one and only
...
\validRule{render-22401}{A \Text object may have the optional SBML
Level~3 Core attributes \token{metaid} and \token{sboTerm}. No other
attributes from the SBML Level 3 Core namespaces are permitted on a
\Text. (Reference: SBML Level~3 Version~1 Core, Section~3.2.)}

\validRule{render-22402}{A \Text object may have the optional SBML
Level~3 Core subobjects for notes and annotations. No other elements
from the SBML Level 3 Core namespaces are permitted on a \Text.
(Reference: SBML Level~3 Version~1 Core, Section~3.2.)}

\validRule{render-22403}{A \Text object may have the optional attributes
\token{render:\-font-family}, \token{render:\-font-weight},
\token{render:\-font-style}, \token{render:\-text-anchor} and
\token{render:\-vtext-anchor}. No other attributes from the SBML Level 3
...
\validRule{render-22404}{A \Text object must contain one and only one
...
\validRule{render-22405}{The value of the attribute
...
\validRule{render-22406}{The value of the attribute
...
\validRule{render-22407}{The value of the attribute
...
\validRule{render-22408}{The value of the attribute
...
\validRule{render-22409}{The value of the attribute
...
\validRule{render-22501}{A \TransformationTwoD object may have the
optional SBML Level~3 Core attributes \token{metaid} and
\token{sboTerm}. No other attributes from the SBML Level 3 Core
namespaces are permitted on a \TransformationTwoD. (Reference: SBML
Level~3 Version~1 Core, Section~3.2.)}

\validRule{render-22502}{A \TransformationTwoD object may have the
optional SBML Level~3 Core subobjects for notes and annotations. No
other elements from the SBML Level 3 Core namespaces are permitted on a
\TransformationTwoD. (Reference: SBML Level~3 Version~1 Core,
Section~3.2.)}

\validRule{render-22503}{A \TransformationTwoD object may have the
...
\validRule{render-22601}{A \Transformation object may have the optional
SBML Level~3 Core attributes \token{metaid} and \token{sboTerm}. No
other attributes from the SBML Level 3 Core namespaces are permitted on
a \Transformation. (Reference: SBML Level~3 Version~1 Core,
Section~3.2.)}

\validRule{render-22602}{A \Transformation object may have the optional
SBML Level~3 Core subobjects for notes and annotations. No other
elements from the SBML Level 3 Core namespaces are permitted on a
\Transformation. (Reference: SBML Level~3 Version~1 Core, Section~3.2.)}

\validRule{render-22603}{A \Transformation object must have the required
...
\validRule{render-22604}{The value of the attribute
...
\validRule{render-22701}{A \GraphicalPrimitiveOneD object may have the
optional SBML Level~3 Core attributes \token{metaid} and
\token{sboTerm}. No other attributes from the SBML Level 3 Core
namespaces are permitted on a \GraphicalPrimitiveOneD. (Reference: SBML
Level~3 Version~1 Core, Section~3.2.)}

\validRule{render-22702}{A \GraphicalPrimitiveOneD object may have the
optional SBML Level~3 Core subobjects for notes and annotations. No
other elements from the SBML Level 3 Core namespaces are permitted on a
\GraphicalPrimitiveOneD. (Reference: SBML Level~3 Version~1 Core,
Section~3.2.)}

\validRule{render-22703}{A \GraphicalPrimitiveOneD object may have the
...
\validRule{render-22704}{The attribute \token{render:\-stroke} on a
\GraphicalPrimitiveOneD must have a value of data type \token{string}.
(Reference: SBML Level~3 Specification for Render Version~1,
\sec{graphicalprimitiveoned-class}.)}

\validRule{render-22705}{The attribute \token{render:\-stroke-width} on
a \GraphicalPrimitiveOneD must have a value of data type \token{string}.
(Reference: SBML Level~3 Specification for Render Version~1,
\sec{graphicalprimitiveoned-class}.)}

\validRule{render-22706}{The value of the attribute
...
\validRule{render-22801}{A \GraphicalPrimitiveTwoD object may have the
optional SBML Level~3 Core attributes \token{metaid} and
\token{sboTerm}. No other attributes from the SBML Level 3 Core
namespaces are permitted on a \GraphicalPrimitiveTwoD. (Reference: SBML
Level~3 Version~1 Core, Section~3.2.)}

\validRule{render-22802}{A \GraphicalPrimitiveTwoD object may have the
optional SBML Level~3 Core subobjects for notes and annotations. No
other elements from the SBML Level 3 Core namespaces are permitted on a
\GraphicalPrimitiveTwoD. (Reference: SBML Level~3 Version~1 Core,
Section~3.2.)}

\validRule{render-22803}{A \GraphicalPrimitiveTwoD object may have the
...
\validRule{render-22804}{The attribute \token{render:\-fill} on a
\GraphicalPrimitiveTwoD must have a value of data type \token{string}.
(Reference: SBML Level~3 Specification for Render Version~1,
\sec{graphicalprimitivetwod-class}.)}

\validRule{render-22805}{The value of the attribute
...
\validRule{render-22901}{A \Style object may have the optional SBML
Level~3 Core attributes \token{metaid} and \token{sboTerm}. No other
attributes from the SBML Level 3 Core namespaces are permitted on a
\Style. (Reference: SBML Level~3 Version~1 Core, Section~3.2.)}

\validRule{render-22902}{A \Style object may have the optional SBML
Level~3 Core subobjects for notes and annotations. No other elements
from the SBML Level 3 Core namespaces are permitted on a \Style.
(Reference: SBML Level~3 Version~1 Core, Section~3.2.)}

\validRule{render-22903}{A \Style object may have the optional
...
\validRule{render-22904}{A \Style object may contain one and only one
...
\validRule{render-22905}{The attribute \token{render:\-name} on a \Style
must have a value of data type \token{string}. (Reference: SBML Level~3
Specification for Render Version~1, \sec{style-class}.)}

\validRule{render-22906}{The attribute \token{render:\-roleList} on a
...
\validRule{render-22907}{The attribute \token{render:\-typeList} on a
\Style must have a value of data type \token{string}. (Reference: SBML
Level~3 Specification for Render Version~1, \sec{style-class}.)}
...
\validRule{render-23001}{A \RenderInformationBase object may have the
optional SBML Level~3 Core attributes \token{metaid} and
\token{sboTerm}. No other attributes from the SBML Level 3 Core
namespaces are permitted on a \RenderInformationBase. (Reference: SBML
Level~3 Version~1 Core, Section~3.2.)}

\validRule{render-23002}{A \RenderInformationBase object may have the
optional SBML Level~3 Core subobjects for notes and annotations. No
other elements from the SBML Level 3 Core namespaces are permitted on a
\RenderInformationBase. (Reference: SBML Level~3 Version~1 Core,
Section~3.2.)}

\validRule{render-23003}{A \RenderInformationBase object must have the
...
\validRule{render-23004}{A \RenderInformationBase object may contain one
...
\validRule{render-23005}{The attribute \token{render:\-name} on a
\RenderInformationBase must have a value of data type \token{string}.
(Reference: SBML Level~3 Specification for Render Version~1,
\sec{renderinformationbase-class}.)}

\validRule{render-23006}{The attribute \token{render:\-programName} on a
\RenderInformationBase must have a value of data type \token{string}.
(Reference: SBML Level~3 Specification for Render Version~1,
\sec{renderinformationbase-class}.)}

\validRule{render-23007}{The attribute \token{render:\-programVersion}
...
\validRule{render-23008}{The attribute
...
\validRule{render-23009}{The attribute \token{render:\-backgroundColor}
on a \RenderInformationBase must have a value of data type
\token{string}. (Reference: SBML Level~3 Specification for Render
Version~1, \sec{renderinformationbase-class}.)}

\validRule{render-23010}{The \ListOfColorDefinitions,
...
\validRule{render-23011}{Apart from the general notes and annotations
...
\validRule{render-23012}{Apart from the general notes and annotations
...
\validRule{render-23013}{Apart from the general notes and annotations
...
\validRule{render-23014}{A \ListOfColorDefinitions object may have the
optional SBML Level~3 Core attributes \token{metaid} and
\token{sboTerm}. No other attributes from the SBML Level 3 Core
...
\validRule{render-23015}{A \ListOfGradientDefinitions object may have
the optional SBML Level~3 Core attributes \token{metaid} and
\token{sboTerm}. No other attributes from the SBML Level 3 Core
...
\validRule{render-23016}{A \ListOfLineEndings object may have the
optional SBML Level~3 Core attributes \token{metaid} and
\token{sboTerm}. No other attributes from the SBML Level 3 Core

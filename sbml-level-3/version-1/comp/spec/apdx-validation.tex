...
\validRule{comp-20607}{A \Submodel object must have the required
  ...
  \token{comp:\-ex\-tent\-Conversion\-Factor}.  No other attributes from the
  Hierarchical Model Composition name\-space are permitted on a \Submodel
  object.  (References: SBML L3 Hierarchical Composition Package V2
...
\validRule{comp-20613}{The value of a \token{comp:\-timeConversionFactor}
  ...
  Composition Package V2 Section~\ref{submodel-timeconversionfactor}.) }
...
\validRule{comp-20614}{The value of a
  ...
  V2 Section~\ref{submodel-extentconversionfactor}.) }
...
\validRule{comp-20622}{The \token{comp:\-timeConversionFactor} attribute
  ...
  (References: SBML L3 Hierarchical Composition Package V2
  Section~\ref{submodel-timeconversionfactor}.) }

\validRule{comp-20623}{The \token{comp:\-extentConversionFactor} attribute
  on a given \Submodel object must be the identifier of a \Parameter
  object defined in the same \Model containing the \Submodel.
  (References: SBML L3 Hierarchical Composition Package V2
  Section~\ref{submodel-extentconversionfactor}.) }

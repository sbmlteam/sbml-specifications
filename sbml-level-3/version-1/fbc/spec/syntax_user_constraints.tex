...
\begin{quote}
 \newtxt{\textbf{This section is a work-in-progress that is based on discussion that took place on the \FBC PWG mailing list and HARMONY 2018 meeting in Oxford.}}\\ Note that where text (or UML) defined in previous FBC specifications has been changed it has been colored \newtxt{red}.
\end{quote}
...
The \SBML \Model class is extended by a \token{listOfUserConstraints} of which it may contain at most one, see also  \ref{fig:fbc_v3_uml_user_constraints}.

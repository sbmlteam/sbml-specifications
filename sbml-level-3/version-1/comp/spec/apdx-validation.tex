...
\validRule{comp-20203}{\begin{blockChanged}The value of attribute \token{comp:required} on
  the \SBML object must be set to \val{true}.    (References: SBML
  Level~3 Package Specification for Hierarchical Model Composition,
  Version~1, \sec{xml-namespace}.)\end{blockChanged}}

...
\else
  ...
  \newcommand{\validationRuleRelTwo}  [1]{\item[#1. \vSymbol\vsp]\input{validation-rules/#1.tex}}
  \newcommand{\consistencyRuleRelTwo} [1]{\item[#1. \cSymbol\csp]\input{validation-rules/#1.tex}}

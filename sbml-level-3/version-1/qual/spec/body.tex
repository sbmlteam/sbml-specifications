...
\TODO{ explain thresholdlevel a bit better}
...
\label{output-class}
The \ListOfOutputs contains zero or more elements of type \Output. A transition with zero outputs can be useful for \TODO{what for ...}

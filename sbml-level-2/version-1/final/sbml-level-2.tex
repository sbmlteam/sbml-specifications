...
\markboth{\textit{SBML Level 2: Working Draft Revision 2}}{\textit{SBML
    Level 2: Working Draft Revision 2}}
...
The \class{Model} structure has one required field, \attrib{id}, used to
...
Under this proposal, \class{Model} would have an optional list of
\class{Event} structures that would describe the time and form of explicit
...
proposed SBML \class{Event} type, to describe how cell mass is halved when

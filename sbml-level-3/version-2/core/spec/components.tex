...
\begin{figure}[htb]
  ...
  \vspace*{-0.5ex}
  \fi
  \verdiff{\includegraphics[scale=0.72]{figs/unitdefinition-uml-l3v1r2}}
             {\includegraphics[scale=0.72]{figs/unitdefinition-uml}}%
  \ifveronespec%
  \vspace*{0.75ex}
  \else%
  \vspace*{-1ex}
...
\vspace*{-3ex}\paragraph{The \token{id} attribute}

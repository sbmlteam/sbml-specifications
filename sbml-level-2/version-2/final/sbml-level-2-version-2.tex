...
\begin{figure}[htb]
  ...
  \caption{The definition of the XML Schema type \primtype{ID}
    ...
    \texttt{(} and \texttt{)} are used for grouping, and the
    character \texttt{*} indicates ``zero or more times''.  The
...
type called \SBase.  This base type is designed to allow a modeler
...
namespaces for parameters internally should be able to accept SBML

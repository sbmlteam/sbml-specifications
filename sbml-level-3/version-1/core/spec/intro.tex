...
Schema~\citep{biron:2000,fallside:2000,thompson:2000} defining the
basic syntax of SBML \thisLV.  The Schema and other materials and
software are available for downloading from the SBML project web

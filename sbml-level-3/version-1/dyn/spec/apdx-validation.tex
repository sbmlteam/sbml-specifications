...
\validRule{dyn-20201}{An \Event object may have the optional attribute \token{dyn:applyToAll}. With the exception of the \token{dyn:cboTerm} attribute from \SBase, no other attributes from the Dynamic Structures namespace are permitted on an \Event object. (References: \sbmlthreedynamic, \sec{subsec:extEvent}.) }

...
If the \Submodel itself references a \Model with its own \Submodel element,
references to extent within the second \Submodel must also be modified according
to the \token{extentConversionFactor} attribute.  The effect is multiplicative:
if the second \Submodel had its own \token{extentConversionFactor},  references
to extent within the second \Submodel would then be converted according to the

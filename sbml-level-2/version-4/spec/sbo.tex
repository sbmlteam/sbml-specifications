...
\begin{table}[bht]
  ...
  \begin{edtable}{tabular}{lll}
    ...
    \SpeciesType        & \changed{material entity} & \sboparticipantphysicalID \\
    \Compartment        & \changed{material entity} & \sboparticipantphysicalID \\
    \Species            & \changed{material entity} & \sboparticipantphysicalID \\
  ...
  child terms. \changed{Note that the important aspect here is the set of specific SBO identifiers, not the SBO term names, because the names of the top node may change as SBO continues to evolve.} See text for further explanations.}

...
\class{SpeciesType}.  The example model in Figure~\ref{fig:hierarchial} demonstrates this feature.
...
The \class{SpecificBond} structure represents the state in which \attrib{bindingSite} is unbound if \attrib{otherBindingSiteReference} is not present.

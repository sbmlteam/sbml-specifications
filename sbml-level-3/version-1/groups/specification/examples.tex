...
In this example, all five ATP \Species are effectively labeled with SBO term \val{SBO:0000248} to indicate they are all small molecules.  An an\changed{n}otation added to \val{ATP\_all\_list} to additionally specify the ChEBI database entry for ATP would have likewise applied to all five ATP \Species.

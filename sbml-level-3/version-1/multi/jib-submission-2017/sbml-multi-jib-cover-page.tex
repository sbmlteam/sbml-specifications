...
\jibtitle{SBML Level 3 package: Multistate, Multicomponent and Multicompartment Species, Version 1, Release 1}
...
\jibauthor{  Fengkai Zhang\iref{niaid},
...
Multicompartment Species Package for SBML Level~3) extends the SBML Level~3
\emph{core} with the ``type'' concept in the Species and Compartment classes
...
Level~3 \emph{Multi} package that thus also becomes a medium for exchanging rule-based models.
}

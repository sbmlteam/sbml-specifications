...
\packageVersion{Version 2, \begin{blockChanged}Release 0.01\end{blockChanged}}
\packageVersionDate{\begin{blockChanged}10 July 2014\end{blockChanged}}
\packageGeneralURL{http://sbml.org/Documents/Specifications/SBML_Level_3/Packages/comp}
\packageThisVersionURL{http://identifiers.org/combine.specifications/sbml.level-3.version-2.comp.version-2}
%\packageWorkingGroupURL{https://lists.sourceforge.net/lists/listinfo/sbml-comp}

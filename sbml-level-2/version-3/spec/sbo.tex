...
\changed{adds additional semantic information} that may be used to
...
certain types of \changed{reaction formulas} as being ones it
...
framework, (2) participant role, (3) quantitative parameter, (4)
...
branches within SBO that apply to that component.  (There are
currently no specific SBO term that correspond to the \Sbml,
...
\changed{defined on \SBase} (Sections~\ref{sec:sbase} and~\ref{sec:annotation-standard}).
...
\changed{attribute} rather than inside the \token{annotation}

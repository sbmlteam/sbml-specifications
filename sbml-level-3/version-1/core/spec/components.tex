...
definition of the unit.  A necessary ramification of this is that
units attached to SBML quantities must be viewed as a kind of
...
\begin{linenomath}
  ...
  \end{equation}
\end{linenomath}
This is despite that a unit definition for millimeters in SBML
...
between the definition of \token{millimeter} above and the

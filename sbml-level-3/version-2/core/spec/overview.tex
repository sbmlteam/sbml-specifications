...
% $Id: overview.tex 10381 2009-12-02 20:32:32Z mhucka $
% $HeadURL: https://svn.code.sourceforge.net/p/sbml/code/trunk/specifications/sbml-level-3/version-1/core/spec/overview.tex $
% ----------------------------------------------------------------

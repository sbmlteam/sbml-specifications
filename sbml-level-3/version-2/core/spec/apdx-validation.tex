...
\ifrevtwospec
  ...
  \newcommand{\validationRuleRelTwo}  [1]{\begin{blockChanged}
                                          \item[\underline{#1}. \mSymbol\vsp]\input{validation-rules/#1.tex}
                                          \end{blockChanged}}
  \newcommand{\consistencyRuleRelTwo} [1]{\begin{blockChanged}
                                          \item[\underline{#1}. \mSymbol\csp]\input{validation-rules/#1.tex}
                                          \end{blockChanged}}
  \newcommand{\modelingRuleRelTwo}    [1]{\begin{blockChanged}
                                          \item[\underline{#1}. \mSymbol\msp]\input{validation-rules/#1.tex}
                                          \end{blockChanged}}

  \newcommand{\removedRule}           [2]{#1 #2}
  \newcommand{\tworefs}               [2]{SBML L3V1 #2}
\else
  \newcommand{\validationRuleVerTwo}  [1]{\begin{blockChanged}
                                          \item[\underline{#1}. \vSymbol\vsp]\input{validation-rules/#1.tex}
                                          \end{blockChanged}}
  \newcommand{\consistencyRuleVerTwo} [1]{\begin{blockChanged}
                                          \item[\underline{#1}. \cSymbol\csp]\input{validation-rules/#1.tex}
                                          \end{blockChanged}}
  \newcommand{\modelingRuleVerTwo}    [1]{\begin{blockChanged}
                                          \item[\underline{#1}. \mSymbol\msp]\input{validation-rules/#1.tex}
                                          \end{blockChanged}}

  \newcommand{\validationRuleRelTwo}  [1]{\item[#1. \mSymbol\vsp]\input{validation-rules/#1.tex}}
  \newcommand{\consistencyRuleRelTwo} [1]{\item[#1. \mSymbol\csp]\input{validation-rules/#1.tex}}
  \newcommand{\modelingRuleRelTwo}    [1]{\item[#1. \mSymbol\msp]\input{validation-rules/#1.tex}}

  \newcommand{\removedRule}           [2]{\changed{(This validation rule does not apply in SBML \thisLV.)}
                                          \footnote{\changed{Original rule:  ``#1''}}}

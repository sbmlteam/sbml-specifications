...
This section describes the \changed{recommended} non-proprietary format for
\changed{the content} of \token{annotation} elements \changed{in SBML} when (a) referring to controlled
...
\changed{Annotations in this format can be located at different depths

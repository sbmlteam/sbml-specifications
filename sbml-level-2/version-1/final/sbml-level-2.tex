...
\item All elements, including \class{Sbml} and
  ...
  type \class{SBase}.  The elements contained inside \class{SBase} are not derived from \class{SBase}.
...
(i.e., $substance/volume$) of the species.   When a compartment identifier

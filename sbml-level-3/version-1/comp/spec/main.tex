...
\author{%
  \begin{tabular}{c>{\hspace{20pt}}c}
    Lucian P. Smith			& Michael Hucka\\[0.2em] 
    \mailto{lpsmith@u.washington.edu}	& \mailto{mhucka@caltech.edu}\\[0.2em]
    ...
    \\[1em]
    Stefan Hoops			& Nicolas Le Nov\`{e}re\\[0.2em]
    \mailto{shoops@vt.edu}		& \mailto{lenov@ebi.ac.uk}\\[0.2em]
    Virginia Bioinformatics Institute	& EMBL-EBI\\
    Virginia Tech			& Wellcome Trust Geneome Campus\\
    Blacksburg, VA, US			& Hinxton, Cambridge, UK\\
    \\[1em]
    Ion Moraru				& Andrew Finney\\[0.2em]
    \mailto{moraru@neuron.uchc.edu}	& \mailto{afinney@caltech.edu}\\[0.2em]
    Univ. of Connecticut Health Center	& Oxfordshire, UK\\
    Farmington, CT, US\\
  \end{tabular}
}
